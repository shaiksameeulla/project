DROP PROCEDURE IF EXISTS udaan_plat.sp_sap_bill_sales_order;
CREATE PROCEDURE udaan_plat.`sp_sap_bill_sales_order`()
BEGIN
...
INSERT INTO ff_f_bill(
   ...
   SELECT
    ...
    round(sum(GrandTotalRounded), 0) AS GrandTotalRounded,
    'Y' AS BillGenerated,
    1 AS CREATED_BY,
