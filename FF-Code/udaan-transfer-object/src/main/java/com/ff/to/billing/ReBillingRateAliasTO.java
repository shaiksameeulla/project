...
public class ReBillingRateAliasTO extends CGBaseTO {
	
	/**
	 * 
	 */
	private static final long serialVersionUID = -5740600786403792394L;
	private Integer consignmentRateId;
	private Integer consignmentId;
	private String contractFor;
	private Character rateCalculated;
	...
	public Character getRateCalculated() {
		return rateCalculated;
	}
	public void setRateCalculated(Character rateCalculated) {
