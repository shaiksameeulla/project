...
/**
 * The Class BillingConsignmentRateTO.
 *
 * @author narmdr
 */
public class BillingConsignmentRateTO extends CGBaseTO {
	
	private static final long serialVersionUID = -3497984265762847858L;

	private Integer billingConsignmentRateId;
	private ConsignmentBillingRateTO consignmentBillingRateTO;
	private BillingConsignmentTO billingConsignmentTO;
	...
	/**
	 * @return the consignmentBillingRateTO
	 */
	public ConsignmentBillingRateTO getConsignmentBillingRateTO() {
		return consignmentBillingRateTO;
	}
	/**
	 * @param consignmentBillingRateTO the consignmentBillingRateTO to set
	 */
	public void setConsignmentBillingRateTO(
			ConsignmentBillingRateTO consignmentBillingRateTO) {
		this.consignmentBillingRateTO = consignmentBillingRateTO;
	}
	/**
	 * @return the billingConsignmentTO
	 */
	public BillingConsignmentTO getBillingConsignmentTO() {
		return billingConsignmentTO;
	}
	/**
	 * @param billingConsignmentTO the billingConsignmentTO to set
	 */
	public void setBillingConsignmentTO(BillingConsignmentTO billingConsignmentTO) {
		this.billingConsignmentTO = billingConsignmentTO;
	}
	/**
	...
	/*private ConsignmentRateTO consignmentRateTO;
	private RateComponentTO rateComponentTO;
