 ...
 *
 */
public class ReBillingGDRTO extends CGBaseTO {
	...
	private List<ReBillingHeaderTO> reBillList;
	...
	public List<ReBillingHeaderTO> getReBillList() {
		return reBillList;
	}
	public void setReBillList(List<ReBillingHeaderTO> reBillList) {
		this.reBillList = reBillList;
	}
