...
public class SAPCustomerTO extends CGBaseTO {
	...
	public String getTansException() {
		return tansException;
	}

	public void setTansException(String tansException) {
		this.tansException = tansException;
	}	
