...
var processStatus=false;
	...
	function validate() {
		...
		var maxRecordsDom=document.getElementById("maxRecords");
		...
		/* try{
				var recordsToFetch=parseInt(maxRecordsDom.value,10);
				
				if(recordsToFetch>100){
					alert("please note that you can download max 100 records only !");
				}
		}catch(e){
			alert(e);
		} */
	...
	<form name="processFrom" method="post" action="bcunServlet.ff" id="processFromId">
		...
		<div
			...
			<table>
						...
						<table align="center">
							...
							<tr>
								...
								<td class="tdTwo"><input type="text" id="maxRecords"
									name="MAX_RECORD" size="15" maxlength="8" style="width: 150px" value ="100"/> </td>
							</tr>
							<tr>
								<td class="lable" align="center">Record Type: <span
									class="mandatory">*</span></td>
								<td class="lable" align="center"><SELECT name="RECORD_TYPE"
									id="recordType" style="width: 150px" onchange="createDropDownForManualDrs(this)">
				...
				<tr><td class="lable" align="center"><b>#Please note that at a time you can download max 100 records only !</b></td></tr>
			</table>
		</div>
	</form>
