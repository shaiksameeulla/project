...
<title> BA/Franchisee/Co-Couriers Delivery Summery Report</title>
</head>
<body>
    <birt:viewer id="birtViewer" 
            reportDesign="ud/report/BAFranchiseeCoDeliverySummeryReport.rptdesign" 
            title="BA/Co-Couries/Franchisee/FS Delivery Summery Report" isHostPage="true"
