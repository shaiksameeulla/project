...
<title> BA/Franchisee/Co-Couriers Delivery Report</title>
</head>
<body>
    <birt:viewer id="birtViewer" 
            reportDesign="ud/report/BAFranchiseeCoCouriersReport.rptdesign" 
            title="BA/Co-Couries/Franchisee/FS Delivery Report" isHostPage="true"
