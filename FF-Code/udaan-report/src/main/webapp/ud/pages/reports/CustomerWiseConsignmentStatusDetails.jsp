...
<script>
		...
		$
				.getJSON(
						...
						function(data) {
							...
							options += '<option value="1000'+cityId+'">ALL</option>'; 
							for ( var i = 0; i < len; i++) {
	...
	function printReport() {
		...
		alert('customer code'+customerCode); */
		...
		var destRegionName = document.getElementById('destOrigin').options[document.getElementById('destOrigin').selectedIndex].text;
		     ...
		     var originBranch = document.getElementById('officeCode').value;
				  ...
				  var url = '/udaan-report/ud/pages/reportveiwer/CustromerWiseConsgStatusReportViewer.jsp?'
					 + "startDate="+StartDate
					 + "&FormDate="+EndDate
	...
	<div id="wraper">
		...
		<div id="maincontent">
			<div class="mainbody">
				<div class="formbox">
					<font size="3"><center>
							<h1>Customer Wise Consignment Status</h1>
						</center></font>
				...
				<form:form name="frm" method="post"
					action="CustomerWiseConsignmentStatusDetails.htm" commandName="branchDO">
		...
		<td width="17%">
		 ...
		 <c:choose>
          ...
          <td width="24%" class="lable"><span class="mandatoryf">*</span>Destination Region</td>
			 <td width="17%">
			<form:select path="region" id="destOrigin"	class="selectBox width130"	onchange="getCitiesByRegCode1(this.value,2)">
	       	<option value="0">Select</option>
            ...
            <td width="17%">
			  <form:select path="cityId" id="city2" class="selectBox width130" >
	          <option value="0">Select</option>	        
              </form:select></td>
         <td colspan="2"><br /> <br /></td> 		 
			</tr>
			  ...
			  <select  id="statusId" property="statusId" class="selectBox width130"> 
                       ...
                       <option value="5">Return To Hub(RTH)</option>
                       <option value="6">Return To Origin(RTO)</option>
                       <option value="7">Out For Delivery</option>
                       <option value="8">Retured To Consignor</option>
