...
function getOfficesForALLOriginBranchs(officeCode) {
	...
	function printReport() {
		...
		var customerName = document.getElementById('customerId').options[document
				.getElementById('customerId').selectedIndex].text;

		var pendingId = document.getElementById('customerId').value;
		...
		var url = '/udaan-report/ud/pages/reportveiwer/tatPerformanceReportRunSheetViewer.jsp?'
				+ "startDate="
				+ startDate
				+ "&endDate="
				+ endDate
		...
		<div id="maincontent">
			<div class="mainbody">
				...
				<form:form name="frm" method="post"
					action="tatPerformanceReport.htm" commandName="branchDO">

					<div class="formTable">
						<table border="0" cellpadding="0" cellspacing="3" width="100%">

							<tr>
								<td width="14%" class="lable"><span class="mandatoryf">*</span>Customer</td>
								<td width="17%"><form:select path="bussinessName"
										id="customerId" class="selectBox width340" multiple="multiple"
										onchange="getCustomerCodeForUps(this.value,1)">
										<option value="0">Select</option>
										<form:options items="${customerList}" itemValue="customerId"
											itemLabel="bussinessName" />
									</form:select></td>
								<td width="14%" class="lable"><sup class="star">*</sup>Start
									Date<bean:message /></td>
								<td width="17%"><input type="text" name="to.startDate"
									style="height: 20px" value="" id="startDate"
								...
								<td width="14%" class="lable"><sup class="star">*</sup>End
									Date<bean:message /></td>
								<td width="17%"><input type="text" name="to.endDate"
									style="height: 20px" value="" id="endDate"
									class="txtbox width130" readonly="readonly"><a
