...
function printReport(){	
	...
	alert("pendingId:"+pendingId);   */
			  ...
			  var url = '/udaan-report/ud/pages/reportveiwer/consignmentWithOutBookingRunSheetViewer.jsp?'	
				 + "startDate="+StartDate  
				 + "&endDate="+EndDate  
...
<a href="/udaan-web/login.do?submitName=silentLoginToApp&screenCode=<c:out value='${menuNode.applScreenDO.screenCode}'/>&moduleName=<c:out value='${menuNode.applScreenDO.moduleName}'/>&appName=udaan-config-admin" target="_blank"><c:out value='${menuNode.applScreenDO.screenName}'/></a>
    ...
    <div class="clear"></div>
     <!-- main content -->
      <div id="maincontent">
        <div class="mainbody">
          <div class="formbox">
           <font size="3"><center><h1>Consignment Dispatched without Booking</h1></center></font>
   ...
   <form:form name="frm" method="post" action="consignmentWithOutBooking.htm" commandName="branchDO" onsubmit="return validate();">
