...
<script>
	...
	function printReport() {
		...
		var originbranch=$("#officeCode" ).val(); 
		...
		if(originCityName=="ALL" && originbranchName=="ALL" && customerName=="ALL"){
			customerId="00002";
		}
		//alert('customerId fro second====>'+customerId);
		        ...
		        var originRegion1 = document.getElementById('region').value;
			     ...
			     var originBranch = document.getElementById('officeCode').value;
				  ...
				  var url = '/udaan-report/ud/pages/reportveiwer/ConsignmentValidationStatusViewer.jsp?'
					 +"StartDate="+StartDate
					 +"&EndDate="+EndDate
	...
	<div id="wraper">
		...
		<div id="maincontent">
			<div class="mainbody">
				<div class="formbox">
					<font size="3"><center>
							<h1>Consignment Validation Status report</h1>
						</center></font>
				...
				<form:form name="frm" method="post"
					action="ConsignmentValidationStatus.htm" commandName="branchDO">

					<div class="formTable">
						<table border="0" cellpadding="0" cellspacing="3" width="100%">

		<tr>
		     <td width="20%" class="lable"><span class="mandatoryf">*</span>Origin Region</td>
		     <td width="17%">
				...
				<td width="17%" class="lable"><span class="mandatoryf">*</span>Origin Station</td>
		<td width="17%">
			  ...
			  <form:options items="${cityDTO}" itemValue="cityId" itemLabel="cityName"/>
				...
				<td width="15%" class="lable"><span class="mandatoryf">*</span>Origin Branch</td>
		        <td width="17%">
			...
			<tr>	
								...
								<td><input type="text" name="to.fromDate"
									...
									title="Select Date"><img src="images/icon_calendar.gif"
										alt="Search" width="12" height="16" border="0"
				...
				<tr>
				    	<td width="20%" class="lable"> <span class="mandatoryf">*</span>Customer Name </td>
              <td width="17%">					
						<c:choose>				
                 ...
                 <form:select path="customerId" id="bussinessName"  class="selectBox width130" >
             		...
             		<%-- <form:options items="${customerOffice}" itemValue="customerId"
				    	...
				    	<td width="20%" class="lable"> <span class="mandatoryf">*</span>Type</td>
              <td width="17%">
					<form:select path="customerId" id="typeId"  class="selectBox width130">
							<option value="0">Select</option>
							<option value="1">Validated Consignments</option>
							<option value="2">Non-Validated Consignments</option>
							</form:select></td>
