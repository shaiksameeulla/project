...
function printReport(){	
	...
	var destRegion=$("destRegion").val();
	var destStation=$("city2").val();
	...
	var destRegionName = document.getElementById('destRegion').options[document.getElementById('destRegion').selectedIndex].text;
	...
	var pendingName=document.getElementById('pendingId').options[document.getElementById('pendingId').selectedIndex].text
 ...
 var url = '/udaan-report/ud/pages/reportveiwer/originHubRecieveAndDispatchViewer.jsp?'	
	 + "date="+Date  
...
<a href="/udaan-web/login.do?submitName=silentLoginToApp&screenCode=<c:out value='${menuNode.applScreenDO.screenCode}'/>&moduleName=<c:out value='${menuNode.applScreenDO.moduleName}'/>&appName=udaan-config-admin" target="_blank"><c:out value='${menuNode.applScreenDO.screenName}'/></a>
    ...
    <div class="clear"></div>
     <!-- main content -->
      <div id="maincontent">
        <div class="mainbody">
          <div class="formbox">
           <font size="3"><center><h1>Origin Hub Recieve And Dispatch Report</h1></center></font>
   ...
   <form:form name="frm" method="post" action="originHubRecieveAndDispatch.htm" commandName="branchDO" onsubmit="return validate();">
      ...
      <div class="formTable">
        <table border="0" cellpadding="0" cellspacing="3" width="100%">
          ...
          <td width="24%" class="lable"><span class="mandatoryf">*</span> Origin Region</td>
            ...
            <c:set var="cityIdValue" value="${cityId}"></c:set>
          <c:choose>
          <c:when test="${officeId eq  '3'}">  
			...
			<td class="lable"><span class="mandatoryf">*</span> Origin Station</td>
            <td width="17%">
		 ...
		 <td width="24%" class="lable"><span class="mandatoryf">*</span> Origin Branch</td>
			 <td width="17%">	
			 <c:set var='branchValue' value="${brachName}"></c:set>
		  ...
		  <tr>
		  <%-- c:choose>
		      <c:when test="${officeId  eq 'Corporate Office'}  ">
		 ...
		 <tr>
		   ...
		   <td width="24%" class="lable"> <span class="mandatoryf">*</span> Type </td>
            ...
            <td width="17%">
				  <form:select path="productSerices" id="productId" class="selectBox width130">
             		<option value="0">Select</option>
