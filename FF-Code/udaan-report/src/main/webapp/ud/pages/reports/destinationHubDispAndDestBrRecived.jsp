...
function printReport(){	
	...
	var loadName = document.getElementById('loadId').options[document.getElementById('loadId').selectedIndex].text;
		...
		var loadId = document.getElementById('loadId').value;
			  if(loadId =='' || loadId==null || loadId=="0"){
			          alert('Please select load');
					  return false;
               }
...
/* 
    ...
    */
			  ...
			  var url = '/udaan-report/ud/pages/reportveiwer/destHubDisToDistBranchRecRunsheetViewr.jsp?'	
				 + "Date="+Date  
...
<a href="/udaan-web/login.do?submitName=silentLoginToApp&screenCode=<c:out value='${menuNode.applScreenDO.screenCode}'/>&moduleName=<c:out value='${menuNode.applScreenDO.moduleName}'/>&appName=udaan-config-admin" target="_blank"><c:out value='${menuNode.applScreenDO.screenName}'/></a>
    ...
    <div class="clear"></div>
     <!-- main content -->
      <div id="maincontent">
        <div class="mainbody">
          <div class="formbox">
           <font size="3"><center><h1>Destination Hub Dispatch v/s Dest Branch Received</h1></center></font>
   ...
   <form:form name="frm" method="post" action="destinationHubDispAndDestBrRecived.htm" commandName="branchDO" onsubmit="return validate();">
      ...
      <div class="formTable">
		...
		<tr>			 
		   <td width="24%" class="lable"> <span class="mandatoryf">*</span> Type </td>
			  <td width="17%"> 
			  <select  id="typeId" property="typeId" class="selectBox width130"> 
			           <option value="0" >Select</option>
            ...
            <td width="17%">
			   ...
			   <td width="24%" class="lable"> <span class="mandatoryf">*</span> Load </td>
              <td width="17%">  
                <select  id="loadId" property="loadId" class="selectBox width130"> 
