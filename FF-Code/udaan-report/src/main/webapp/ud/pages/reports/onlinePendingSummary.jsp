...
/* 	
	...
	function printReport() {
		...
		var url = '/udaan-report/ud/pages/reportveiwer/onlinePendingSummaryViewer.jsp?'
				+ "branch="
				+ branchCode
				+ "&originRegionName="
				+ destRegionName
	...
	<div id="wraper">
		...
		<div id="maincontent">
			<div class="mainbody">
				<div class="formbox">
					<font size="3"><center>
							<h1>Branch Wise Online Pending Summary Report</h1>
						</center></font>
				...
				<form:form name="frm" method="post"
					action="onlinePendingSummary.htm" commandName="branchDO">
