...
/* 	
	...
	function printReport() {
		...
		var url = '/udaan-report/ud/pages/reportveiwer/stationWiseDRSReportViewer.jsp?'
				+ "fromDate="
				+ Date
				+ "&endDate="
				+ Date1
		...
		<div id="maincontent">
			<div class="mainbody">
				...
				<form:form name="frm" method="post"
					action="stationWiseDRSReport.htm" commandName="branchDO">
