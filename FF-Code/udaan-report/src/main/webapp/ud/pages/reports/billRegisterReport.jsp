		...
		var originBranchName = document.getElementById('officeCode').options[document.getElementById('officeCode').selectedIndex].text;	
		     ...
		     var originBranch = document.getElementById('officeCode').value;
				  ...
				  if(StartDate > EndDate){
					  alert("User Restriction:To Date should not be Less than From Date:");
					  return true;
				  }
				...
				/*   var noOfDays=calculateDateDiff(StartDate,EndDate);
				  ...
				  */
				    ...
				    var url = '/udaan-report/ud/pages/reportveiwer/billRegisterReportViewer.jsp?'
	...
	<div id="wraper">
		...
		<div id="maincontent">
			<div class="mainbody">
				<div class="formbox">
					<font size="3"><center>
							<h1> Bill Register Summary Report </h1>
						</center></font>
				...
				<form:form name="frm" method="post"	action="billRegisterReport.htm" commandName="branchDO">
			...
			<c:otherwise>
			  ...
			  <c:choose>
				   <c:when test="${offices.size() > 1 && cityList.size() == 1}">
					  ...
					  <form:select path="branchCode"	id="officeCode" class="selectBox width130" onchange="getBranch()" >
				  ...
				  <c:when test="${cityList.size() == 1}">
				     ...
				     <c:when test="${offices.size() > 1 && cityDTO.size() == 1}">
					  <td width="14%" class="lable"><span class="mandatoryf">*</span>Origin Branch</td>
					  <td width="17%" align="left">
					  <form:select path="branchCode"	id="officeCode" class="selectBox width130" onchange="getBranch()">
					  <option value="0">SELECT</option>
			   ...
			   <td width="14%" class="lable"><span class="mandatoryf">*</span>Month</td>
		       <td width="17%">
		         <select     onchange="getMonthValues(this.value);" >
                  <option value="0">Select</option>
			   ...
			   <select>
		            ...
		            <td width="14%" class="lable"><span class="mandatoryf">*</span>From Date</td>
					<td width="17%" align="left">
					<form:select path="startDate"	id="startdate" class="selectBox width130"  onchange="getMonthValuesForEndDate(this.value)">
			        <option value="0">Select</option>
			        <form:options items="${startDate}" itemValue="startDate"/>
					</form:select></td>
					
					<td width="14%" class="lable"><span class="mandatoryf">*</span>To Date</td>
					<td width="17%" align="left">
					<form:select path="endDate"	id="enddate" class="selectBox width130"  >
			        <option value="0">Select</option>
