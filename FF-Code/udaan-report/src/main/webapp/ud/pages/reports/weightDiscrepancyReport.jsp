...
function printReport(){	
	...
	alert("Type :"+typeId);
	 alert(" Date :"+date); */
			 ...
			 var url = '/udaan-report/ud/pages/reportveiwer/weightDiscrepancyRunSheetViewer.jsp?'	
				 + "date="+date   
...
<a href="/udaan-web/login.do?submitName=silentLoginToApp&screenCode=<c:out value='${menuNode.applScreenDO.screenCode}'/>&moduleName=<c:out value='${menuNode.applScreenDO.moduleName}'/>&appName=udaan-config-admin" target="_blank"><c:out value='${menuNode.applScreenDO.screenName}'/></a>
    ...
    <div class="clear"></div>
     <!-- main content -->
      <div id="maincontent">
        <div class="mainbody">
          <div class="formbox">
           <font size="3"><center><h1>Weight Discrepancy Report</h1></center></font>
   ...
   <form:form name="frm" method="post" action="weightDiscrepancyReport.htm" commandName="branchDO" onsubmit="return validate();">
      ...
      <div class="formTable">
        <table border="0" cellpadding="0" cellspacing="3" width="100%">
          <tr>
			...
			<%-- <c:choose>
				<c:when test="${user.officeTo.officeName eq 'Corporate Office'}">  
            	<form:select path="region" class="selectBox width130"  onchange="getCitiesByRegCode(this.value,1)">
					<option value="0" >Select</option>
					<form:options items="${regionList}" itemValue="regionCode" itemLabel="regionName"/>
				</form:select>
		  ...
		  <%-- 
			<td class="lable"> <span class="mandatoryf">*</span> Origin Branch</td>	
            <td width="17%">
