...
<script>
	...
	function printReport() {
		...
		/* var productName = document.getElementById('productId').options[document.getElementById('productId').selectedIndex].text; */
		     ...
		     var url = '/udaan-report/ud/pages/reportveiwer/BAFranchiseeCoCourierDeliverySummeryReportViewer.jsp?'
					 + "startDate="+StartDate
					 + "&EndDate="+EndDate          
					 + "&branch="+branch
		...
		<div id="maincontent">
			<div class="mainbody">
				...
				<form:form name="frm" method="post"
					action="BAFranchiseeCoCourierDeliverySummeryReport.htm" commandName="branchDO">
