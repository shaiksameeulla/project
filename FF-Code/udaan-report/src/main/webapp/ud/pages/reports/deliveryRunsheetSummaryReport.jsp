...
/* 	
	...
	function printReport() {
		...
		var url = '/udaan-report/ud/pages/reportveiwer/drsSummaryReportViewer.jsp?'
				+ "fromDate="
				+ Date
				+ "&endDate="
				+ Date1
				...
				+ "&stationName="
				+ destStationName
				+ "&loadNumber=" + load + "&loadName=" + loadName;
	...
	<div id="wraper">
		...
		<div id="maincontent">
			<div class="mainbody">
				<div class="formbox">
					<font size="3"><center>
							<h1>Delivery Runsheet Summary Report</h1>
						</center></font>
				...
				<form:form name="frm" method="post"
					action="deliveryRunsheetSummaryReport.htm" commandName="branchDO">
