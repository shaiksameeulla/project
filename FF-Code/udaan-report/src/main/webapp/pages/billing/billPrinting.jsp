			...
			<html:form method="post" styleId="billPrintingForm">
				...
				<div id="maincontent">
					<div class="mainbody">
						...
						<div class="formTable" style="margin-top: 30px; overflow: hidden;">
							...
							<div class="cleardiv" style="padding-top: 30px;">
								...
								<div style="text-align: left;">
									...
									<span style="vertical-align: top; margin-left: 23px;"><bean:message
										...
										style="height: 80px; margin-left: 34px; margin-right: 20px; width: 401px;">
										...
										<logic:present name="customerList" scope="request">
											<logic:iterate id="customers" name="customerList">
												<option value="${customers.customerId}">
													<c:out
														value="${customers.businessName}-${customers.customerCode}" />
												</option>
											</logic:iterate>
										</logic:present>
									</select>
							...
							<div class="forminnerele cleardiv"
								style="margin-bottom: 30px; margin-top: 30px; overflow: hidden; padding-top: 20px;">
								<div>

									<span class="span50"> <sup class="star">*</sup> <%-- <bean:message
										key="label.invoicePrinting.StartDate" /> --%> Bill Generated
										Start Date
									</span> <span class="span50"> <html:text
											property="to.startDate" styleClass="txtbox width100"
											styleId="startDate" readonly="true" /> <a href="#"
								...
								<div>
									<span class="span50"> <sup class="star">*</sup> <%-- <bean:message
										key="label.invoicePrinting.EndDate" /> --%> Bill Generated End
										Date
									</span> <span class="span50"> <html:text property="to.endDate"
											styleClass="txtbox width100" styleId="endDate"
				...
				<div class="button_containerform">
					<html:button property="print" styleClass="btnintform"
						styleId="printBtn" onclick="printBillsInBulkUsingBirtViewer();">
						BulkPrint
					</html:button>
					<html:button property="print" styleClass="btnintform"
