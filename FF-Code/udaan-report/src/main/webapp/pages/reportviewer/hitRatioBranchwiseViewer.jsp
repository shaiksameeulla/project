...
<body>
	...
	<birt:viewer id="birtViewer"
		reportDesign="reports/brr-hit-ratio-destination-branch-wise.rptdesign"
		title="Hit Ratio Branchwise Report" isHostPage="true"
		...
		<birt:param name="SeriesLabel" value='<%=(request.getParameter("SeriesLabel")== null ? ""  : request.getParameter("SeriesLabel"))%>'></birt:param>
