...
<body>
	<birt:viewer id="birtViewer"
		reportDesign="reports/consignmentBookingDetails.rptdesign"
	   ...
	   <birt:param name="product"
		...
		<birt:param name="customerType"
			value='<%=(request.getParameter("customerType") == null ? null
							: request.getParameter("customerType"))%>'></birt:param>
							
		<birt:param name="customerTypeDesc"
			value='<%=(request.getParameter("customerTypeDesc") == null ? null
							: request.getParameter("customerTypeDesc"))%>'></birt:param>
												
		<birt:param name="priority"
			value='<%=(request.getParameter("priority") == null ? null
							: request.getParameter("priority"))%>'></birt:param>
