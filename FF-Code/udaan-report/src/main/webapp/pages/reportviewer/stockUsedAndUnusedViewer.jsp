...
<title>Stock Used & Unused</title>
</head>
<body>
       <birt:viewer id="birtViewer" 
              reportDesign="reports/stockUsedAndUnused.rptdesign"
              title="Stock Used & Unused"
              isHostPage="true"
            ...
            <birt:param name="client" value='<%= ( request.getParameter("client") == null ? "" : request.getParameter("client") ) %>'></birt:param>             
              <birt:param name="jdbcFilePath" value='<%= ( request.getRealPath("") == null ? "" : request.getRealPath("")+"/WEB-INF/jdbc.properties" ) %>'></birt:param>
