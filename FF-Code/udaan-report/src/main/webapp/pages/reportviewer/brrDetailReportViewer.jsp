...
<%--               <birt:param name="LoadNumber" value='<%= ( request.getParameter("LoadNumber") == null ? "" : request.getParameter("LoadNumber") ) %>'></birt:param> --%>
              ...
              <birt:param name="LoadNumber" value='${param.LoadNumber}'/>
              <birt:param name="ReportType" value='${param.ReportType}'/>
               <birt:param name="ReportTypeName" value='${param.ReportTypeName}'/>
