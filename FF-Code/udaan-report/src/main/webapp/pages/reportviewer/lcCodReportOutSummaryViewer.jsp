...
<body>
       <birt:viewer id="birtViewer" 
              reportDesign="reports/out-summary.rptdesign"
              title="LcCod Out Summary"
              isHostPage="true"
             ...
             <birt:param name="SummaryOptionName" value='<%= ( request.getParameter("SummaryOptionName") == null ? "" : request.getParameter("SummaryOptionName") ) %>'></birt:param>
