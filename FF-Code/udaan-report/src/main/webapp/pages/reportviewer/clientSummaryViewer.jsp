...
<title>Clientwise Summary, Bkng & Status Report</title>
</head>
<body>
	<birt:viewer id="birtViewer"
		reportDesign="reports/clientSummaryProductWise.rptdesign"
		title="Clientwise Summary, Bkng & Status Report" isHostPage="true"
		...
		<birt:param name="destRegionList"
			value='<%=(request.getParameter("destRegionList") == null ? ""
							: request.getParameter("destRegionList"))%>'></birt:param>
		<birt:param name="destStationList"
