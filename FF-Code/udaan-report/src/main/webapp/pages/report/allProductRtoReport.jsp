...
<body>
			...
			<div id="maincontent">
				<div class="mainbody">
					<div class="formbox">
						<h1>
							<bean:message
								key="label.allProductRtoReport.allProductRtoReportHeader" />
						</h1>
					...
					<div class="formTable">
						...
						<td class="lable"><sup class="star">* </sup> <bean:message
								...
								<td><select name="product" id="product" onchange = "getCustomerByStationAndProduct();"
	...
	<td><c:choose>
			...
			<c:when test="${wrapperReportTO.getCityTO().size() == 0}">
				<select name="to.station" id="stationList"
					class="selectBox width130" onchange = "getCustomerByStationAndProduct();">
					<option value="Select">Select</option>
				</select>
					...
					<c:forEach var="city" items="${wrapperReportTO.getCityTO()}">
						<option value="${city.cityId }" >
							...
							<td class="lable" width="15%"><sup class="star">* </sup> <bean:message
								...
								<td width="18%"><select name="to.destRegion"
									id="destRegionList" class="selectBox width130"
								...
								<td width="18%"><select name="to.destStation"
									id="destStationList" class="selectBox width130">
										<option>
											<bean:message key="label.common.select" />
										</option>
								</select></td>
								...
								<td class="lable" width="15%"><sup class="star">* </sup> <bean:message
									...
									<td width="18%"><input type="text" name="to.fromDate"
...
<td class="lable" width="15%"><sup class="star">* </sup> <bean:message
								...
								<td width="18%"><input type="text" name="to.toDate"
		...
		<div class="button_containerform">
			<html:button property="Submit" styleClass="btnintform"
				onclick="showproductRTOReport();" styleId="Submit">
