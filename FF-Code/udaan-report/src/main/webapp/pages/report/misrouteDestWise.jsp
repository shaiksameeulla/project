		...
		<div id="wraper">
			...
			<div id="maincontent">
				<div class="mainbody">
					<div class="formbox">
						<h1>
							<bean:message key="label.misrouteDestWise.misrouteDestWiseHeader" />
						</h1>
							...
							<tr>
								...
								<td width="18%"><select class="selectBox width130"
									id="reportType">
										...
										<option value="originRegionwise">OriginRegionwise</option>
										<option value="mis-DestRegiowise">Mis-Dest Regionwise
										</option>
										<option value="transhipmetWise">Transhipment Wise</option>
			...
			<div class="button_containerform">
				<html:button property="print" styleClass="btnintform"
					styleId="printBtn" onclick="showMisRouteReport();">
