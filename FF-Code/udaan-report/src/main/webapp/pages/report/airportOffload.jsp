...
<body>
	<form method="post" id="airportOffloadReportForm"
		action="/udaan-report/airportOffloadReport.do?submitName=getOffloadReport">
		<div id="wraper">
			<div class="clear" />
			<div id="maincontent">
				<div class="mainbody">
					<div class="formbox">
						<h1>
							<bean:message key="label.airportOffload.airportOffloadHeader" />
						</h1>
			...
			<div class="button_containerform">
				<html:button property="print" styleClass="btnintform"
					styleId="printBtn" onclick="showAirportOffloadReport();">
