		...
		<div id="wraper">
			...
			<div id="maincontent">
				<div class="mainbody">
					<div class="formbox">
						<h1>
							<bean:message
								key="label.originHitRatioReport.originHitRatioReportHeader" />
						</h1>
					...
					<div class="formTable">
						<table border="0" cellpadding="0" cellspacing="3" width="100%">
							<tr>
								...
								<td><c:choose>
										...
										<c:otherwise>
											<select name="to.regionTo" id="regionList"
												class="selectBox width130"
												onchange="getStationsListForBrr('regionList', 'stationList,branchList,destRegionList');">
												<option value="Select">Select</option>
												<c:forEach var="regions"
													items="${wrapperReportTO.getRegionTO()}">
								...
								<td class="lable"><sup class="star">* </sup> <bean:message
										key="dispatch.label.mblgatepass.destinationRegion" /></td>
									<!-- onchange="getHitRatioOriginWiseDestinationStation('destRegionList');"> -->
								<td><select name="to.regionTo" id="destRegionList"
									class="selectBox width130"
									onchange="getDestinationStationsListForBrr('destRegionList','destStationList');">
										<option>
							...
							<tr>
								...
								<td class="lable"><sup class="star">* </sup> <bean:message
										key="dispatch.label.mblgatepass.destinationStation" /></td>
								<td><select name="to.station" id="destStationList"
									class="selectBox width130">
										<option>
											<bean:message key="label.common.select" />
										</option>
			...
			<div class="button_containerform">
				<html:button property="Submit" styleClass="btnintform"
					styleId="Submit" onclick="showHitRatioOriginwiseReport();">
