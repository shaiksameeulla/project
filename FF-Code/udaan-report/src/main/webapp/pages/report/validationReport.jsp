...
<script type="text/javascript" src="js/report/validationReport.js"></script>
...
<!--wraper-->
		...
		action="/udaan-report/validationReport.do?submitName=getValidationReport">
<div id="wraper">
    <!-- main content -->
    <div id="maincontent">
    	<div class="mainbody">
           	<div class="formbox">
       			<h1><bean:message key="label.outgoinghubreport.validationReport" /></h1>
