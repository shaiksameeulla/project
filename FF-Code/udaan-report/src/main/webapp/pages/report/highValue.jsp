		...
		<div id="wraper">
			...
			<div id="maincontent">
				<div class="mainbody">
					<div class="formbox">
						<h1>
							<bean:message key="label.HighValueReport.HighValueReportHeader" />
						</h1>
						...
						<table border="0" cellpadding="0" cellspacing="3" width="100%">
							...
							<tr>
								...
								<td class="lable"><bean:message
										key="label.consgBookingReport.value" /></td>
								<td><select class="selectBox width130">
										<option>
											<bean:message key="label.common.select" />
										</option>
										<option></option>
			...
			<div class="button_containerform">
				<html:button property="Submit" styleClass="btnintform"
					onclick="showHighValueReport();" styleId="Submit">
					<bean:message key="button.submit" />
				</html:button>
				<html:button property="cancel" styleClass="btnintform"
					styleId="cancelBtn" onclick="clearFields();">
