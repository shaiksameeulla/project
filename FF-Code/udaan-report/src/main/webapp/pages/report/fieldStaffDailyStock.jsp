...
<script type="text/javascript" src="js/report/fieldStaffDailyStockReport.js"></script>
...
<!--wraper-->
		...
		action="/udaan-report/fieldStaffDailyStockReport.do?submitName=getFieldStaffDailyStockReport">
<div id="wraper">
    <!-- main content -->
    <div id="maincontent">
    	<div class="mainbody">
           	<div class="formbox">
       			<h1><bean:message key="label.stockreport.fieldStaffDailyStockReport" /></h1>
           	...
           	<div class="formTable">
        		<table border="0" cellpadding="0" cellspacing="12" width="100%">
                  	...
                  	<tr>
            			...
            			<td width="18%">
            				<select name="to.branch" id="branchList" class="selectBox width130" onchange="getEmployees('branchList')">
									<option value=""><bean:message key="label.common.select"/></option>
								</select>
              			</td>
            			<td width="16%" class="lable"></td>
            			<td width="16%" class="lable"><sup class="star">*</sup><bean:message key="label.stockreport.periodFrom" /></td>
            			<td width="18%">
            			...
            			<td width="16%" class="lable"></td>
            			<td width="16%" class="lable"><bean:message key="label.stockreport.csaname" /></td>
            			<td width="18%">
            			<select name="to.employeeList" id="employeeList" class="selectBox width130" >
									<option value=""><bean:message key="label.common.select"/></option>
