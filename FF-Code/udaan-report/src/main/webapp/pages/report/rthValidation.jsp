...
<script type="text/javascript" src="js/report/rthValidationReport.js"></script>
...
<!--wraper-->
		...
		action="/udaan-report/rthValidationReport.do?submitName=getRthValidationReport">
<div id="wraper">
    <!-- main content -->
    <div id="maincontent">
    	...
    	<div class="mainbody">
           	<div class="formbox">
       			<h1><bean:message key="label.outgoinghubreport.rthValidationReport" /></h1>
...
<tr>
	<td class="lable"><sup class="star">* </sup> Destination Region</td>
	...
	<td class="lable">Destination Station</td>
	...
	<td class="lable">Destination Branch</td>
	...
	<div class="button_containerform">
    	...
    	<html:button property="Cancel" styleClass="btnintform" onclick="clearRTHScreen()" styleId="Cancel" >
