...
<script type="text/javascript" src="js/report/stockTransferReport.js"></script>
...
<!--wraper-->
		...
		action="/udaan-report/stockTransferReport.do?submitName=getStockTransferReport">
<div id="wraper">
    <!-- main content -->
    <div id="maincontent">
    	<div class="mainbody">
           	<div class="formbox">
       			<h1><bean:message key="label.stockreport.stockTransferReport" /></h1>
