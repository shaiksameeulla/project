...
<script type="text/javascript" src="js/report/DiscrepancyCounterAlertReport.js"></script>
</head>
<body>
	<form method="post" id="consignmentReportForm">
		<div id="wraper">
			...
			<div id="maincontent">
				<div class="mainbody">
					<div class="formbox">
						<h1>
							<bean:message
								key="label.discrepencyCounterReport.discrepencyCounterReportHeader" />
						</h1>
			...
			<div class="button_containerform">
				<html:button property="Submit" styleClass="btnintform" onclick="getDiscrepancyCounterAlertReport()" styleId="Submit">
