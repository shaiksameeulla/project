...
<body >
	...
	<div class="mainbody">
	<div class="formbox">
	<h1><bean:message key="label.lcCodReport.printHeaderInSummary" /></h1>
	...
	&nbsp;<bean:message key="label.common.FieldsareMandatory" />
			...
			<%-- <jsp:include page="/pages/report/lcCodReport.jsp" /> --%>
			...
			<div class="button_containerform">
				<html:button property="print" styleClass="btnintform"
					styleId="printBtn" onclick="printLcCodReportInSummary();">
		    ...
		    <input type="hidden" name = "reportName" id="reportName"  value="lcCodInSummary"/>
	</div>
	</div>  
	</div>
		<!-- <input type="hidden" name = "reportName" id="reportName"  value="lcCodInSummary"/> -->
