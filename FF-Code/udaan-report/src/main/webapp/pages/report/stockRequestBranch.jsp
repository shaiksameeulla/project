...
<script type="text/javascript" src="js/report/stockRequestBranchReport.js"></script>
...
<!--wraper-->
		...
		action="/udaan-report/stockRequestBranchReport.do?submitName=getStockRequestBranchReport">
<div id="wraper">
			<div class="clear" />
			<div id="maincontent">
				<div class="mainbody">
					<div class="formbox">
						<h1><bean:message key="label.stockreport.stockRequestRHOBranchReport" /></h1>
...
<tr>
	...
	<td><c:choose>
			...
			<c:when test="${wrapperReportTO.getOfficeTO().size() == 0 }">
				<select name="to.station" id="branchList" class="selectBox width130"
					onchange="getCustomerList('branchList')">
					<option value="Select">Select</option>
				</select>
			</c:when>
			<c:otherwise>
							...
							<tr>
								...
								<td>
									...
									<option value=""> 
										...
										</option><c:forEach var="product" items="${productTo}" varStatus="loop"><option value="${product.itemTypeId}"><c:out value="${product.itemTypeName}"/></option></c:forEach></select>
...
<!-- 								</td> -->
			...
			<div class="button_containerform">
				<html:button property="Submit" styleClass="btnintform"
					onclick="printReport();" styleId="Submit">
					<bean:message key="button.submit" />
				</html:button>
				<html:button property="cancel" styleClass="btnintform"
					styleId="cancelBtn" onclick="clearSRScreen();">
