...
<script type="text/javascript" language="JavaScript" src="js/report/BranchProjection.js"></script>
<script type="text/javascript" charset="utf-8" src="js/report/commonReport.js"></script>
<script type="text/javascript" charset="utf-8" src="js/report/moment.js"></script>
</head>
<body>
		...
		<div id="wraper">
			...
			<div id="maincontent">
				<div class="mainbody">
					<div class="formbox">
						<h1>
							<bean:message key="label.branchprojectionreport.header" />
						</h1>
					...
					<div class="formTable">
						...
						<tr>
							...
							<td><c:choose>
									...
									<c:otherwise>
										<select name="to.station" id="branchList" class="selectBox width130"
											onchange="getClientList('branchList') clearItemProduct();">
											<option value="Select">Select</option>
						...
						<!-- tr>
							...
							<tr>
								...
								<td>
									...
									class="txtbox width130" readonly="readonly" onblur="calcWorkingDays1();"> 
									<a href="#"
								...
								<td class="lable"> 
									<bean:message key="label.leads.product" />
								</td>
								<td><select name="product" id="product" class="selectBox width130" onchange="calcWorkingDays1();">
								<option value="">
											Select
										</option>
										<option value="">
							...
							<tr>
								<td class="lable"> 
									<bean:message key="label.branchprojectionreport.expecteddays" />
								</td>
								<td>        				
              				        <input name="expectedDays" id="expectedDays" maxlength="2" class="textbox width130" onkeypress="return checkForOnlyNumeric(event);" />	              		   
                      			</td>              					
							</tr>
						</table>
					</div>
			...
			<div class="button_containerform">
				<html:button property="Submit" styleClass="btnintform"
					onclick="branchProjectionDetails();" styleId="Submit">
