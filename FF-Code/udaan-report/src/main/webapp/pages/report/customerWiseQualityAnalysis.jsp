...
<script type="text/javascript" charset="utf-8"
	src="js/report/ClientGained.js"></script>
</head>
<body >
	<form method="post" name="consignmentReportForm" id="consignmentReportForm"
		...
		<div id="wraper">
			...
			<div id="maincontent">
				<div class="mainbody">
					<div class="formbox">
						<h1>Customer Wise Quality Report</h1>
					...
					<div class="formTable">
						...
						<%@include file="commonReportInclude.jsp" %>
							...
							<tr>
 								<td class="lable"><sup class="star">* </sup><bean:message key="label.leads.product" /></td> 
...
<%-- 										<c:if test="${product.productName ne 'Cash' && product.productName ne 'Emotional Bond'}"> --%>
...
<!-- 								</select></td> -->
									<td><select name="product" id="product" class="selectBox width130">
										<!-- <option value="Select">Select</option> -->
										 <option value="All">
											<bean:message key="label.all" /></option> 
								...
								<td class="lable">Fuel %</td>
								<td>  <select name="fuel" id="fuel" class="selectBox width130">										
			...
			<div class="button_containerform">
				<html:button property="Submit" styleClass="btnintform"
					onclick="showCustomerWiseQualityReport();" styleId="Submit">
					<bean:message key="button.submit" />
				</html:button>
				<html:button property="cancel" styleClass="btnintform"
					styleId="cancelBtn" onclick="clearCustomerQualityScreen();">
