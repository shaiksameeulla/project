		...
		<div id="wraper">
			...
			<div id="maincontent">
				<div class="mainbody">
					<div class="formbox">
						<h1>
							<bean:message key="label.brrreport.brrDetailHeader" />
						</h1>
...
<!-- 								</select></td> -->
							...
							<tr>
								...
								<td class="lable"><sup class="star">* </sup> <bean:message
										key="label.brrDateWiseReport.ReportType" /></td>
								<td>
									<select name="to.reportType" id="reportType" class="selectBox width130">
										<option><bean:message key="label.common.select" /></option>
										<c:forEach var="Item" items="${reportTypeTOs}">
											<option value="${Item.stdTypeCode}">${Item.description}</option>
										</c:forEach>
									</select>
								</td>
			...
			<div class="button_containerform">
				<html:button property="Submit" styleClass="btnintform"
					styleId="Submit" onclick="getBrrDetailReport();">
