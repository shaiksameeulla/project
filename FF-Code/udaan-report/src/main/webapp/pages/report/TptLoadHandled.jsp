...
<script type="text/javascript" src="js/report/TptLoadHandled.js"></script>
</head>
<body>
		...
		<div id="wraper">
			...
			<div id="maincontent">
				<div class="mainbody">
					<div class="formbox">
						<h1>
							<bean:message key="dispatch.label.tptloadhandled.title" />
						</h1>
					...
					<div class="formTable">
						<table border="0" cellpadding="0" cellspacing="3" width="100%">
							<tr>
								...
								<td class="lable"><sup class="star">*</sup>&nbsp;<bean:message
										key="dispatch.label.tptloadhandled.HubOffice" /></td>
							...
							<tr>
								...
								<td class="lable"><sup class="star">* </sup><bean:message
										key="dispatch.label.mblgatepass.reportType" /></td>
								<td><select name="reportType" id="reportType"
									class="selectBox width130">
										<option value="">
											<bean:message key="dispatch.label.select" />
										</option>
										<option value="O">
											<bean:message key="dispatch.label.mblgatepass.dispatch" />
										</option>
										<option value="I">
											<bean:message key="dispatch.label.mblgatepass.received" />
										</option>
								</select></td>
								<td class="lable"><sup class="star">* </sup> <bean:message
										key="dispatch.label.originhubtally.fromdate" /></td>
								...
								<td class="lable"><sup class="star">* </sup> <bean:message
										key="dispatch.label.originhubtally.todate" /></td>
			...
			<div class="button_containerform">
				<html:button property="Submit" styleClass="btnintform"
					onclick="getTptDetails()" styleId="Submit">
