...
<body >
	...
	<div class="mainbody">
	<div class="formbox">
	<h1><bean:message key="label.lcCodReport.printHeaderInPreAlert" /></h1>
	...
	&nbsp;<bean:message key="label.common.FieldsareMandatory" />
							...
							<td width="10%" class="lable"><sup class="star">* </sup>
								...
								<td width="16%">
									<html:select property="to.sortOrder" styleId="sortOrderList" 
										...
										<html:option value="DLVDT"> Delivery Date 
									</html:option>
									</html:select>
								</td>
			...
			<div class="button_containerform">
				<html:button property="print" styleClass="btnintform"
					styleId="printBtn" onclick="printLcCodReportInPreAlert();">
		    ...
		    <input type="hidden" name = "reportName" id="reportName"  value="lcCodPreAlert"/>
	</div>
	</div>  
	</div>
