...
function clearScreen(){
	var url="./stockCancellationReport.do?submitName=getStockCancellationReport";
...
function getOrgStationsList(){
	...
	if(region){
		var url = './stockCancellationReport.do?submitName=getStations&region='
		+ region;
...
function getBranchList(id){
	...
	var cityID=$("#"+id).val();		
	if(cityID){
		var url = './stockCancellationReport.do?submitName=getBranchList&cityID=' + cityID;
...
function getProductList(id){
	...
	var branchId=$("#"+id).val();		
	var url = '.stockCancellationReport.do?submitName=getProductList&branchId=' + branchId;
...
function printReport(){	
	...
	if(isNull(region)|| isNull(station) || isNull(branch) ){
		...
		if(checkDate()){	
			...
			var url = '/udaan-report/pages/reportviewer/stockCancellationViewer.jsp?'			
			 + "&StartDate="+startDate 
			 + "&EndDate="+endDate
			 + "&Region="+region
			 + "&Station="+station
...
function getCustomerList(id){
	...
	var cityID=$("#"+id).val();	
	var url = './stockCancellationReport.do?submitName=getCustomerList&cityID=' + cityID;	
