...
function clearScreen(){
	var url="./fieldStaffDailyStockReport.do?submitName=getFieldStaffDailyStockReport";
...
function getOrgStationsList(){
	...
	if(region){
		var url = './fieldStaffDailyStockReport.do?submitName=getStations&region='
			+ region;
...
function getBranchList(id){
	...
	var cityID=$("#"+id).val();		
	if(cityID){		
	var url = './fieldStaffDailyStockReport.do?submitName=getBranchList&cityID=' + cityID;
...
function getProductList(id){
	...
	var branchId=$("#"+id).val();		
	var url = './fieldStaffDailyStockReport.do?submitName=getProductList&branchId=' + branchId;
...
function printReport(){	
	...
	var csaName=$("#employeeList" ).val();

	
	//if(isNull(region)){
		
		
	//if(isNull(region)|| isNull(station) || isNull(branch) || isNull(csaName))
		...
		if(checkDate()){	
			...
			alert("Branch:" + branch);
			alert("csa Name"+csaName);
	*/
			
			var url = '/udaan-report/pages/reportviewer/fieldStaffDailyStockViewer.jsp?'			
			 + "&StartDate="+startDate 
			 + "&EndDate="+endDate
			 + "&Region="+region
			 + "&Station="+station
...
function getEmployees(id){
	...
	var url = './fieldStaffDailyStockReport.do?submitName=getEmployeeList&branchId=' + branchId;
