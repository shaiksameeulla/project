...
function clearScreen(){
	var url="./validationReport.do?submitName=getValidationReport";
...
function getOrgStationsList(){
	...
	if(region){	
	var url = './validationReport.do?submitName=getStations&region='
		+ region;
...
function getBranchList(id){
	...
	var cityID=$("#"+id).val();		
	if(cityID){	
	var url = './validationReport.do?submitName=getBranchList&cityID=' + cityID;
...
function getProductList(id){
	...
	var branchId=$("#"+id).val();		
	var url = './validationReport.do?submitName=getProductList&branchId=' + branchId;
...
function printReport(){	
	...
	*/
			...
			var url = '/udaan-report/pages/reportviewer/validationViewer.jsp?'			
			 + "&StartDate="+startDate 
			 + "&EndDate="+endDate
			 + "&Region="+region
			 + "&Station="+station
