...
<script language="JavaScript" src="js/jquery-tab-1.9.1.js" type="text/javascript" ></script>
...
<html:form action="calculateRate.do?submitName=calculateRate" method="post" styleId="rateCalculatorForm">
	...
	<table width = "70%" border="0">
		<tr> 		
			...
			<option value="PC000017">PC000017-International in coming</option>
			<option value="PC000018">PC000018-Prepaid COD</option>
		...
		<tr>
			...
			<option value="" selected="selected">---Select ----</option>
			<option value="F">First FLight</option>
		...
		<tr> 
			...
			<html:select property="to.ebPreference" styleId="preference"  styleClass="selectBox width130">
			    <option value="" selected="selected">---Select ----</option>
			    	<c:forEach var="ebPreference" items="${ebPreferences}" varStatus="loop">
		              <option value="${ebPreference.preferenceCode}" ><c:out value="${ebPreference.preferenceCode}"/></option>
		            </c:forEach>  
			</html:select>
			</td>
		</tr>
		...
		<tr> 
			<td   class="lable">Rate Calculation FOR: </td>
			<td>
			<html:select property="to.rateCalculationFOR" styleId="rateCalculationFOR"  styleClass="selectBox width130">
			    <option value="B" selected="selected">Booking</option>
			    <option value="O">MEC - Octroi</option>
			</html:select>
			</td>
			<td  class="lable"> Octroi Amount</td>
			<td><html:text property="to.octroiAmount" styleClass="txtbox width130" styleId="octroiAmount" value = ""/></td>
		</tr>
		<tr> 
			<td   class="lable">Octroi State: </td>
			<td><html:text property="to.octroiState" styleClass="txtbox width130" styleId="octroiState" value = ""/>
			</td>
			<td   class="lable"> Number of CN FOR Bulk Calculation</td>
			<td><html:text property="to.cnLimit" styleClass="txtbox width130" styleId="CnLimit" value = ""/></td>
		</tr>
		<tr> 
