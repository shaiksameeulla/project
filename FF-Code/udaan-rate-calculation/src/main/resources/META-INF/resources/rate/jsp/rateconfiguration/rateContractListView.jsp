...
<script type="text/javascript" charset="utf-8" src="rate/js/rateconfiguration/rateContractListView.js"></script>
...
<html:form action="/rateContract.do?submitName=listViewRateContract"
		styleId="rateContractForm">
		<div id="wraper"> 
         <div class="clear"></div>
          <!-- main content -->
          <div id="maincontent">
    <div class="mainbody">
              <div class="formbox">
        <h1><strong><bean:message key="label.Rate.ContractListView" /></strong></h1>
              ...
              <div class="formTable">
                <table border="0" cellpadding="0" cellspacing="3" width="100%">
                  <tr>
                    ...
                    <td width="15%" >
                    <html:text styleId="fromDate" property="rateQuotationListViewTO.fromDate" styleClass="txtbox width100" readonly="true" tabindex="-1" onfocus="validateFromDate(this);"/>
                    ...
                    <td width="15%">
                     <html:text styleId="toDate" property="rateQuotationListViewTO.toDate" styleClass="txtbox width100" readonly="true" tabindex="-1" onfocus="validateToDate(this);"/>
                    ...
                    <td>
					<html:select styleId="regionDropId" property="rateQuotationListViewTO.regionDropId" styleClass="selectBox width145" onchange="getStationsByRegion(this.value);">
                  ...
                  <tr>
                    ...
                    <logic:present name="regionalAllList" scope="request">
                      <td width="15%">
                    <html:select styleId="cityRegDropId" property="rateQuotationListViewTO.cityRegDropId" styleClass="selectBox width140">
                    <html:option value="A">ALL</html:option>
                    </html:select>
                    </td>
                     </logic:present>
                    ...
                    <html:select styleId="cityRegDropId" property="rateQuotationListViewTO.cityRegDropId" styleClass="selectBox width140">
                    <html:option value="A">ALL</html:option>
                    <c:forEach var="station" items="${stationRegList}" varStatus="loop">
                    	<html:option value="${station.cityId}">${station.cityName}</html:option>
                      </c:forEach>
                    </html:select>
                    </td>
                     </logic:notPresent>
                    ...
                    <td>
                    <logic:present name="contrctStatusList" scope="request">
                    <html:select styleId="status" property="rateQuotationListViewTO.status" styleClass="selectBox width140">
                      <c:forEach var="status"	items="${contrctStatusList}" varStatus="loop">
                    ...
                    <td class="lable"><bean:message
											key="label.Rate.contract" /></td>
                    <td width="17%"><html:text styleId="rateContractNo" property="rateQuotationListViewTO.contractNo" styleClass="txtbox width130"/></td>
                  </tr>
                  <tr>
                    <td align="right" valign="top" colspan="6"><input name="Search" type="button" value="Search" class="button" onclick="getContracts();" title="Search"/></td>
                  </tr>
                </table>
</div>
              <div id="demo">
        ...
        <table cellpadding="5" cellspacing="0" border="0" class="display" id="example" width="100%">
                  <thead>
            <tr>
                      ...
                      <th width="12%"><bean:message
											key="label.ListView.GroupKey" /></th>
                      <th width="12%"><bean:message
