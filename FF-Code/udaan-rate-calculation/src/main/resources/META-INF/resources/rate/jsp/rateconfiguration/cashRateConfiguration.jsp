...
<script type="text/javascript" charset="utf-8" src="rate/js/rateconfiguration/cashRateConfigHeader.js"></script>
<script type="text/javascript" charset="utf-8" src="rate/js/rateconfiguration/courierCashRateConfig.js"></script>
<script type="text/javascript" charset="utf-8" src="rate/js/rateconfiguration/airCargoCashRateConfig.js"></script>
<script type="text/javascript" charset="utf-8" src="rate/js/rateconfiguration/trainCashRateConfig.js"></script>
<script type="text/javascript" charset="utf-8" src="rate/js/rateconfiguration/priorityCashRateConfig.js"></script>
<script type="text/javascript" charset="utf-8" src="rate/js/rateconfiguration/fixedChargesCashRateConfig.js"></script>
<script type="text/javascript" charset="utf-8" src="rate/js/rateconfiguration/rtoChargesCashRateConfig.js"></script>
<script type="text/javascript" charset="utf-8" src="rate/js/rateconfiguration/priorityFixedChargesCashRateConfig.js"></script>
<script type="text/javascript" charset="utf-8" src="rate/js/rateconfiguration/priorityRtoChargesCashRateConfig.js"></script>
        	...
        	<div class="formTable">
				<table border="0" cellpadding="0" cellspacing="2" width="100%">
	    			<tr>
	              		...
	              		<td width="15%">
	              			<html:text property="to.toDateStr" styleId="toDateStr" styleClass="txtbox width100" onfocus="validateToDate(this);" readonly="true" tabindex="-1" />
	        				&nbsp;<a href="#" onclick="validateFromDtToSetToDt('toDateStr',this.value);" id="toDtStr" title="Select Date"><img src="images/icon_calendar.gif" alt="Search" width="16" height="16" border="0" class="imgsearch"/></a>
	        			</td>
	             		<td width="13%" class="lable"><sup class="star"><bean:message key="symbol.common.star" /></sup>&nbsp;<bean:message key="label.Rate.Region" /></td>
	              		<td width="24%">
	              			...
	              			<html:select property="to.regionId" styleId="regionId" styleClass="selectBox width170" onchange="getOriginSector(this);searchCashRateDtls();" disabled="${disabledForRenew}">
