...
function getQuotations(){
	...
	quotationNo = getDomElementById("rateQuotationNo").value;
	
	offType = getDomElementById("officeType").value;
	...
	if(!isNull(getDomElementById("cityRegDropId"))){
		...
		if(validateDates()){
			var url = "./rateQuotation.do?submitName=getRateQuotationListViewDetails&region="+regionId+"&city="+cityId+"&fromDate="+getDomElementById("fromDate").value+"&toDate="+getDomElementById("toDate").value+"&status="+getDomElementById("status").value+"&userId="+userId+"&quotationNo="+quotationNo+"&type="+getDomElementById("type").value+"&ofcType="+getDomElementById("officeType").value;
...
function openQuotation(quotationNo,quotationType,userEmpId,salesUserEmpId,quotUserId,regionalName,cityName,salesOfcName,salesPerson){
	var url = "./rateQuotation.do?submitName=listViewRateQuotation&rateQuotationNo="+quotationNo+"&type="+quotationType+"&userEmpId="
	+userEmpId+"&salesUserEmpId="+salesUserEmpId+"&quotUserId="+quotUserId+"&regionalName="+regionalName+"&cityName="
	+cityName+"&salesOfcName="+salesOfcName+"&salesPerson="+salesPerson+"&page=listView&empType="+getDomElementById("type").value;
	window.open(
