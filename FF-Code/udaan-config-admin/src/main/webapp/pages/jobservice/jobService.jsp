...
<html:form action="/jobService.do?submitName=listViewJobService"
    ...
    <div class="mainbody">
              <div class="formbox">
        <h1><strong>Job Services</strong></h1>
              ...
              <div class="formTable">
                <table border="0" cellpadding="0" cellspacing="3" width="100%">
                  <tr>
                    ...
                    <td width="18%" >
                    <html:text styleId="fromDate" property="to.fromDate" styleClass="txtbox width130" readonly="true" tabindex="-1" onfocus="validateFromDate(this);"/>
                    ...
                    <td width="18%">
                     <html:text styleId="toDate" property="to.toDate" styleClass="txtbox width130" readonly="true" tabindex="-1" onfocus="validateToDate(this);"/>
                    ...
                    <td width="20%" class="lable"><sup class="star">*</sup>&nbsp;Process Name:</td> 
                    
                    <td>
					<html:select styleId="processCode" property="to.processCode" styleClass="selectBox width130">
                    <html:option value=""><bean:message key="label.option.select" /></html:option>
                    	<logic:present name="jobProcessList" scope="request">
                    	<c:forEach var="process" items="${jobProcessList}" varStatus="loop">
                  ...
                  <tr>
                    ...
                    <td width="17%"><html:text styleId="jobNumber" property="to.jobNumber" styleClass="txtbox width130"/></td>
                  </tr>
                  <tr>
                    <td align="right" valign="top" colspan="6"><input name="Search" type="button" value="Search" class="button" onclick="getJobServices();" title="Search"/></td>
                  </tr>
                </table>
</div>
              <div id="demo">
