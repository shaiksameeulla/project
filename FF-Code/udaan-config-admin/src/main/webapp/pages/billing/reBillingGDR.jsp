...
<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<script type="text/javascript" charset="utf-8" src="js/billing/reBillingGDR.js"></script>
		...
		<body>
			 <html:form method="post" styleId="reBillingGDRForm">
<!--wraper-->
<div id="wraper"> 
          <div class="clear"></div>
          <!-- main content -->
    ...
    <div class="mainbody">
              <div class="formbox">
                <h1><bean:message key="label.reBillingGDR.header"/></h1>
              ...
              <div class="formTable">
               ...
               <tr>
                  ...
                  <td></td>
                   <td >
                     <%-- <html:button  property="search" styleClass="btnintformbig2" styleId="search" onclick="checkMandatoryOnce();">
    				<bean:message key="button.search"/></html:button> --%>
    				<input name="Browse" type="button" value="Search" class="button"  title="Search"   onclick="getReBillNos();"/>
    				</td>
                  </tr>                
                </table>
               </div>
        ...
        <table cellpadding="0" cellspacing="0" border="0" class="display" id="rebillGdr" width="100%">
                  <thead>
            <tr>
                       <th width="4%" align="center" ><bean:message key="label.reBillingGDR.srNo"/></th>
                      <th width="7%" align="center" ><bean:message key="label.reBillingGDR.reBillNo"/></th>
                      <th width="5%" align="center"><sup class="star"></sup><bean:message key="label.reBillingGDR.totalCNForReport"/></th>
                      <th width="7%"><sup class="star"></sup><bean:message key="label.reBillingGDR.oldContTotal"/></th>
                      <th width="7%"><sup class="star"></sup><bean:message key="label.reBillingGDR.newContTotal"/></th>
                      <th width="10%"><sup class="star"></sup><bean:message key="label.reBillingGDR.generateReport"/></th>
                    </tr>
                   <%--  <c:forEach var="dtlsTOs" items="${reBillGdrTO.reBillList}" varStatus="loop">
				    <tr>
					    <td align="center"><c:out value="${loop.count }"/></td>
					    
					    <td align="center" ><c:out value="${dtlsTOs.reBillingNumber}"/></td>
					    <td align="center" ><c:out value="${dtlsTOs.pincode}"/></td>
					    <td align="center" ><c:out value="${dtlsTOs.totalCns}"/></td>
					    <td align="center" ><c:out value="${dtlsTOs.oldContrFor}"/></td>
					    <td align="center"><c:out value="${dtlsTOs.newContrFor}"/></td>
					    <td><html:hidden property="to.reBillingId" styleId="rebillId${loop.count}" value="${dtlsTOs.reBillingId}"/>
								<a id="reBillGene${loop.count}" href="#" onclick="populatePickupRunsheet('${dtlsTOs.reBillingId}');">Click</a></td>
   ...
   <%--  <html:button property="Generate Difference Report" styleClass="btnintformbig2" styleId="Generate Difference Report" onclick="checkMandatoryOnce();">
    <bean:message key="button.label.generateDiffReport"/></html:button> --%>
