...
<%@ include file="/pages/advancedcalendar/html/calendar.html"%>
...
<link href="js/jquery/ui-themes/base/jquery.ui.all.css" rel="stylesheet">
 ...
 <script language="JavaScript" src="js/jquery/jquery.blockUI.js" type="text/javascript" ></script> 
	...
	<script language="JavaScript" type="text/javascript" src="js/disableRightClick.js"></script>
	<script type="text/javascript" src="js/jquerydropmenu.js"></script><!-- DataGrids -->
	
	<script type="text/javascript" charset="utf-8" src="js/jquery.dataTables.js"></script>
	<script type="text/javascript" charset="utf-8" src="js/FixedColumns.js"></script>
	<script language="javaScript" type="text/javascript" src="js/advancedcalendar/calendar.js"></script>
  <script language="javaScript" type="text/javascript" src="js/advancedcalendar/ts_picker.js"></script>
