...
<script type="text/javascript" language="JavaScript" src="js/mec/expense/expenseEmployee.js"></script>
...
var employeeList = fnGetEmployeeList();

function fnGetEmployeeList() {
	var text = "";
	<c:forEach var="emp" items="${employeeList}" varStatus="status">  
		text = text + "<option value=${emp.employeeId}>${emp.firstName} ${emp.lastName} - ${emp.empCode}</option>";
	</c:forEach>
	return text;		   	
}
...
<html:form styleId="expenseEntryForm">
	<!-- main content -->
    	<div id="maincontent">
    		<div class="mainbody">
            	<div class="formbox">
        			<h1><bean:message key="label.expense.employee.title" /></h1>
              	...
              	<div class="formTable">
                	<table border="0" cellpadding="0" cellspacing="5" width="100%">
                 	...
                 	<tr>
	                    ...
	                    <td width="15%">
	                    	<html:select property="to.expenseType" styleId="expenseType" styleClass="selectBox width130" onchange="checkGridEmpty(this,expenseFor.value);" onkeypress="return callEnterKey(event,document.getElementById('employeeIds1'));">
		            ...
		            <tr>	
	                    ...
	                    <td width="15%"><html:text property="to.bankBranchName" styleId="bankBranchName" styleClass="txtbox width130" maxlength="50" disabled="true" onkeypress="return callEnterKeyAlphaNum(event,document.getElementById('employeeIds1'));"/></td>
	                    <td width="15%" class="lable"><sup class="star">*</sup><bean:message key="label.mec.amount" />:</td>
	                    <td width="17%" colspan="3"><html:text property="to.finalAmount" styleId="finalAmount" styleClass="txtbox width130" onkeypress="return onlyDecimal(event);" onblur="setAmountFormatZero(this);" readonly="true" tabindex="-1" /></td>
                  	</tr>
               		</table>
				</div>
	        		...
	        		<table cellpadding="0" cellspacing="0" border="0" class="display" id="expenseEntryTable" width="100%">
						<thead>
	            			<tr>
								...
								<th width="13%" align="center"><sup class="star">*</sup><bean:message key="label.expense.empName" /></th>
								<th width="14%"><sup class="star">*</sup><bean:message key="label.mec.amount" /></th>
								<th width="19%"><sup class="star">*</sup><bean:message key="label.expense.remark" /></th>
	                    	</tr>
	          			</thead>
	                  	<tbody>
	       				</tbody>
