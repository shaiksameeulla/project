...
<script type="text/javascript" language="JavaScript" src="js/mec/expense/expenseOffice.js"></script>
...
<html:form styleId="expenseEntryForm">
	...
	<div id="maincontent">
    	<div class="mainbody">
        	<div class="formbox">
        		<h1><bean:message key="label.expense.office.title" /></h1>
        	...
        	<table border="0" cellpadding="0" cellspacing="5" width="100%">
            	<tr>
		            ...
		            <td width="16%" class="lable">
		            	<%-- <sup class="star">*</sup>&nbsp;<bean:message key="label.expense.documentDate" />: --%>
		            	<sup class="star">*</sup>&nbsp;<bean:message key="label.expense.expenseFor" />:
		            </td>
		            <td width="17%">
		            	<%-- <html:text property="to.documentDate" styleId="documentDate" styleClass="txtbox width100" maxlength="10" readonly="true" onfocus="validateDocDate(this);" onkeypress="return callEnterKey(event,document.getElementById('expenseFor'));"/>
				...
				<tr>
					...
					<td width="20%">
						<%-- <html:select property="to.expenseFor" styleId="expenseFor" styleClass="selectBox width130" onchange="getExpenseScreen(this);" onkeypress="return callEnterKey(event,document.getElementById('expenseType'));">
							<logic:present name="expenseForList" scope="request">					
								<html:optionsCollection property="to.expenseForList" label="label" value="value" />
							</logic:present>
						</html:select> --%>
					...
					<td width="15%">
						<html:select property="to.expenseType" styleId="expenseType" styleClass="selectBox width130" onchange="getModeOfExpense(this);" onkeypress="return callEnterKey(event,document.getElementById('finalAmount'));">
				...
				<tr>
		            ...
		            <td width="15%"><html:text property="to.chequeNumber" styleId="chequeNumber" styleClass="txtbox width130" maxlength="6" disabled="true" onkeypress="return onlyNumberAndEnterKeyNav(event,this,'chequeDate');" onblur="validateChqNumber(this);" /></td>
		            <td width="15%" class="lable"><sup class="star">*</sup><bean:message key="label.mec.chequeDate" />:</td>
		            <td width="17%">
		            	<html:text property="to.chequeDate" styleId="chequeDate" styleClass="txtbox width130" readonly="true" disabled="true" onkeypress="return callEnterKey(event,document.getElementById('bank'));"/>
          		...
          		<tr>
		            ...
		            <td width="17%"><html:text property="to.finalAmount" styleId="finalAmount" styleClass="txtbox width130" maxlength="10" onkeypress="return onlyNumberAndEnterKeyNav(event,this,'txRemarks');" onblur="setAmountFormatZero(this);" /></td>
		            <td class="lable"><sup class="star">*</sup><bean:message key="label.expense.remark" />:</td>
		            <td width="20%"><html:text property="to.txRemarks" styleId="txRemarks" styleClass="txtbox width130" maxlength="100" onkeypress="return callEnterKey(event,document.getElementById('Save'));" />
		            </td>
          		</tr>
			</table>
		</div>
