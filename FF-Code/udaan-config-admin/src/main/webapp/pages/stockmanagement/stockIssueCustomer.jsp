...
<div id="wraper"> 
	...
	<div id="maincontent">
    	...
    	<div class="mainbody">
        	<div class="formbox">
        		<h1><bean:message key="stock.label.issue.cust.title" /></h1>
              ...
              <table border="0" cellpadding="0" cellspacing="12" width="100%">
              	<tr>
		            ...
		            <td width="21%"><html:text property="to.createdIssueDate" styleClass="txtbox width140" size="11" readonly="true" tabindex="-1" onkeypress="return enterKeyNav('itemId',event.keyCode);" /><%-- &nbsp;<html:text property="to.createdIssueTime" styleClass="txtbox width65" size="11" readonly="true" /> --%></td>
                ...
                <tr>
		           	<td width="16%" class="lable"><sup class="star">*</sup><bean:message key="stock.label.issue.custList" />:</td>
		            <td width="21%">
		            	<html:select property="to.recipientId" styleId="recipientId" 
	              			styleClass="selectBox width145" onkeypress="return enterKeyNav('issuedQuantity',event.keyCode);" onchange="getSelectedCustomerType(this)"><!-- onchange="getRepCode(this)" -->
	                		<html:option value=""><bean:message key="stock.label.issue.list.cust" /></html:option>
	                		<logic:present name="customerMap" scope="request">
                         		<html:optionsCollection name="customerMap" label="value" value="key"/>
                         	</logic:present>
		              	</html:select>
		            </td>
            	...
            	<tr>
		            ...
		            <td width="21%"><html:text property="to.startSerialNumber" styleId="startSerialNumber" styleClass="txtbox width140"  maxlength="12" onchange="validateSeries(this,'Customer')" onkeypress="return enterKeyNav('Submit',event.keyCode);" /></td>
		            <td width="17%" class="lable"><sup class="star">*</sup><bean:message key="stock.label.issue.cn.end" />:</td>
		            <td width="46%"><html:text property="to.endSerialNumber" styleId="endSerialNumber" styleClass="txtbox width140" maxlength="12" readonly="true" size="14" tabindex="-1"/></td>
                </tr>
                <tr>
                 	<td width="16%" class="lable"><bean:message key="stock.label.issue.num" />:</td>
            		<td width="21%" colspan="3"><html:text property="to.stockIssueNumber" styleId="stockIssueNumber" styleClass="txtbox width140"  onkeypress="return findOnEnterKey('issueToCust',event.keyCode);" maxlength="12" size="14"/>
  		          			<!-- <a href="#" id="issueToCustomerSearch" onclick="find('issueToCust')"><img src="images/magnifyingglass_yellow.png" alt="Search" /></a> -->
  		          			<%-- <html:button styleClass="searchButton" property="FIND" alt="Search" styleId="issueToCustomerSearch" onclick="find('issueToCust')" /> --%>
  		          			<html:button styleClass="btnintgrid" property="FIND" alt="Search" styleId="issueToCustomerSearch" onclick="find('issueToCust')">
  	...
  	<div class="button_containerform">
		<c:choose>
			...
			<c:otherwise>
				<html:button property="Submit" styleClass="btnintform" styleId="Submit" onclick="submitForm('customer')">
    				<bean:message key="button.submit" /></html:button>
    			
   			</c:otherwise>
		</c:choose>  	
		<html:button property="Cancel" styleClass="btnintform" styleId="Cancel" onclick="clearScreen('stockIssueCust')" >
