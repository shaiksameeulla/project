...
<script type="text/javascript" charset="utf-8" src="js/stockmanagement/stockReturn.js"></script>
		...
		<div class="mainbody">
		  ...
		  <div class="formTable">
		  		<table border="0" cellpadding="0" cellspacing="7" width="100%">
		            ...
		            <tr>
			            <td width="20%" class="lable"><bean:message key="stock.label.return.stockIssueNo"/>:</td>
            			<td width="16%" colspan="3"><html:text property="to.stockIssueNumber" styleId="stockIssueNumber"  styleClass="txtbox width145" maxlength="12" size="14" onkeydown="return findOnEnterKey('stockIssue',event.keyCode);"/>
            				
            				<html:button styleClass="btnintgrid" property="FIND" styleId="" alt="Search" onclick="find('stockIssue');">
            					<bean:message key="button.search" />
			            	</html:button>
            			</td>
		            </tr>
