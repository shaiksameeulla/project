...
<script type="text/javascript" charset="utf-8" src="js/leads/leadsPlanning.js"></script>
...
<div id="wraper"> 
	<div id="maincontent">
   		<div class="mainbody">
        	<div class="formbox">
      			<h1><bean:message key="label.leadPlaning.header"/></h1>
            ...
            <div class="formTable">
            	<table border="0" cellpadding="0" cellspacing="5" width="100%">
               		<tr>
            			...
            			<html:hidden property="to.leadStatus" styleId="status"/> 
            			...
            			<td width="11%" class="lable"><bean:message key="label.leadPlaning.leadNumber"/></td>
           				<td width="24%"><html:text property="to.leadNumber" styleClass="txtbox width140" styleId="leadNumber"  readonly="true" value="" />  <!-- onchange="getLeadDetailsByLeadNumber();" --></td>
          				<td width="11%" class="lable"><bean:message key="label.leads.CustomerName"/></td>
           				<td width="24%"><html:text property="to.customerName" styleClass="txtbox width140" maxlength="50" styleId="custName" readonly="true" value="" onkeypress="return onlyAlphabet4Lead(event);" /></td>
          			</tr>
              	</table>
             </div>
            <div id="demo">
     			...
     			<table cellpadding="0" cellspacing="0" border="0" class="display" id="leadsPlan" width="100%">
		            <thead>
		       			<tr>
		          	 		<th width="3%" align="center"><input type="checkbox" class="checkbox" name="chk0" id="chk0" onchange="checkUncheckAllRows('leadsPlan')" /></th>
	...
	<div class="button_containerform">
		<html:button property="save" styleClass="btnintform" onclick="saveOrUpdateLeadPlaningDetails();" styleId="save" >
			<bean:message key="button.label.save" locale="display" /></html:button>
		<html:button styleClass="btnintform" property="Cancel" 	onclick="cancelPage();" styleId="cancel">
			<bean:message key="button.label.Cancel" locale="display" /></html:button>
		<%-- <html:button styleClass="btnintform" property="Print" styleId="Print">
			<bean:message key="label.baBookingDox.Print" locale="display" /></html:button>  --%>
		<html:button property="delete" styleId="delete" styleClass="btnintform"  onclick="deleteLeadsDataRow();">
			<bean:message key="button.label.delete" locale="display" /></html:button>
	</div>
</div>
<!-- wrapper ends -->
</html:form>
