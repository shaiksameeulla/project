			...
			.fnAddData(
					[
							...
							'<input type="text" name="to.amounts" id="amounts'
									+ rowCount
									+ '" class="txtbox width110" maxlength="8" onfocus="validateHeaderForGrid();setFinalAmount(this);" onkeypress="return onlyNumberAndEnterKeyNav(event,this,\'remarks'
									+ rowCount
									+ '\');" onblur="setNewAmtFormat(this);" onchange="setFinalAmount(this);" />',
