 ...
 * 
 */
public class ConsignmentRateCalculationScheduler extends QuartzJobBean {

	/** The LOGGER. */
	private final static Logger LOGGER = LoggerFactory
			.getLogger(ConsignmentRateCalculationScheduler.class);
	...
	protected void executeInternal(JobExecutionContext arg0)
		...
		try {
			consignmentRateCalculationService
					.executeConsignmentRateCalculation("B");
		} catch (Exception e) {
			LOGGER.error(
