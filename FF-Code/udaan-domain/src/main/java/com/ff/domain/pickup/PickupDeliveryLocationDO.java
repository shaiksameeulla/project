...
public class PickupDeliveryLocationDO extends CGMasterDO {
	...
	private PickupDeliveryContractDO pickupDlvContract;
	 ...
	 */
	public PickupDeliveryContractDO getPickupDlvContract() {
		return pickupDlvContract;
	}

	/**
	 * @param pickupDlvContract
	 *            the pickupDlvContract to set
	 */
	public void setPickupDlvContract(PickupDeliveryContractDO pickupDlvContract) {
