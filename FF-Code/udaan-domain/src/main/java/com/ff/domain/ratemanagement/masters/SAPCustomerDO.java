 ...
 * @author2 hkansagr
 */
public class SAPCustomerDO extends CGBaseDO {
	...
	private Date csdTimeStmap = DateUtil.getCurrentDate();
	private String exception;
	private Date createdDate = DateUtil.getCurrentDate();
	private Date updateDate = DateUtil.getCurrentDate();
	...
	/**
	 * @return the csdTimeStmap
	 */
	public Date getCsdTimeStmap() {
		return csdTimeStmap;
	}

	/**
	 * @param csdTimeStmap
	 *            the csdTimeStmap to set
	 */
	public void setCsdTimeStmap(Date csdTimeStmap) {
		this.csdTimeStmap = csdTimeStmap;
	}
