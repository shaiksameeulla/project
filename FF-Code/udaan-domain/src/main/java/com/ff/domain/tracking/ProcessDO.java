...
public class ProcessDO extends CGMasterDO {
	...
	private String trackingTxtMnf;
	
	
	/**
	 * @return the trackingTxtMnf
	 */
	public String getTrackingTxtMnf() {
		return trackingTxtMnf;
	}
	/**
	 * @param trackingTxtMnf the trackingTxtMnf to set
	 */
	public void setTrackingTxtMnf(String trackingTxtMnf) {
		this.trackingTxtMnf = trackingTxtMnf;
	}
