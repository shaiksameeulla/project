...
public class ExpenseEntriesDO extends CGFactDO {
	...
	/**
	 * @param expenseEntryId the expenseEntryId to set
	 */
	 ...
	 */
	public ExpenseDO getExpenseDO() {
		return expenseDO;
	}

	/**
	 * @param expenseDO the expenseDO to set
	 */
	public void setExpenseDO(ExpenseDO expenseDO) {
	...
	/**
	 * @param totalExpenseEntryAmt the totalExpenseEntryAmt to set
	 */
