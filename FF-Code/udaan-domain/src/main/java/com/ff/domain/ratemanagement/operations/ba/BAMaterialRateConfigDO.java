...
public class BAMaterialRateConfigDO extends CGFactDO {
	...
	private Set<BAMaterialRateDetailsDO> baMaterialRateDtls;
	
	
	/**
	 * @return the baMaterialRateDtls
	 */
	public Set<BAMaterialRateDetailsDO> getBaMaterialRateDtls() {
	...
	public void setBaMaterialRateDtls(
			Set<BAMaterialRateDetailsDO> baMaterialRateDtls) {
