package com.cg.lbs.bcun.constant;
...
public interface BcunConstant {
	...
	String OUTBOUND_PROCESS_NAME_TRANSACTIONAL_MASTER ="transactionalMaster";
	...
	//OUTBOUND OFFICE CATEGORY
	String OUTBOUND_OFFICE_CATEGORY_A ="A";
	String OUTBOUND_OFFICE_CATEGORY_B ="B";
	String OUTBOUND_OFFICE_CATEGORY_C ="C";
	String OUTBOUND_OFFICE_CATEGORY_D ="D";
	String OUTBOUND_OFFICE_CATEGORY_E ="E";
	
	//Query
	String QUERY_GET_ALL_ACTIVE_DATA_SYNC_OFFICE_BY_CATEGORY = "getAllActiveDatasyncOfficeByCategory";
	
	//Query Param
	String PARAM_OUTBOUND_OFFICE_CATEGORY = "outboundOfficeCategory";
	
	String BCUN_UPLOAD="upload";
	String BCUN_DOWNLOAD="download";
