...
<script type="text/javascript"
	src="js/drs/update/drsUpdateForNormalPriorityPpx.js"></script>
</head>
<body>
		...
		<div id="wraper">
			...
			<div id="maincontent">
				<div class="mainbody">
					<div class="formbox">
						<h1>
							<bean:message key="label.drs.update.npppx" />
						</h1>
								...
								<c:forEach var="drsDtls" items="${npDrsForm.to.detailsToList}"
									...
									<tr class="${loop.index % 2 == 0 ? 'even' : 'odd'}">
										...
										<td><html:text
												...
												tabindex="-1" /></td>
												<td align="center">
													<input type="text" name="to.rowAmount" id="rowAmount${loop.count}" value="${drsDtls.amount}" class="txtbox width50" readonly="readonly" tabindex="-1"/>
													</td>
										...
										<td><html:select property="to.rowCompanySealSign"
												...
												value='${drsDtls.companySealSign}' disabled="true" onkeypress="return enterKeyNavforDrsUpdateContactNum(event.keyCode,'${loop.count}','rowContactNumber')">
												<html:option value="">
													<bean:message key="label.common.select" />
												</html:option>
											...
											<td><html:select property="to.rowRelationId"
												...
												styleClass="selectBox width140"
												value='${drsDtls.relationId}' disabled="true">
												<html:option value="">
													<bean:message key="label.common.select" />
												</html:option>
