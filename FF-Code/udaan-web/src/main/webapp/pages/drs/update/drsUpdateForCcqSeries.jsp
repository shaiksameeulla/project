...
<script type="text/javascript" src="js/drs/update/drsUpdateForCcqSeries.js"></script>		
...
<div id="wraper"> 
   <!-- main content -->
    ...
    <div class="mainbody">
              <div class="formbox">
        <h1><bean:message key="label.drs.update.CCAndQSeries"/></h1>
        ...
        <table cellpadding="0" cellspacing="0" border="0" class="display"
                  ...
                  <c:forEach var="drsDtls" items="${creditCardDrsForm.to.creditCardDrsdetailsToList}"
									varStatus="loop">
									<tr class="${loop.index % 2 == 0 ? 'even' : 'odd'}">
										...
										<td><html:select property="to.rowDeliveryType"
												...
												value='${drsDtls.deliveryType}' onchange="enableForDlvTypeForCcq('${loop.count}')" onkeydown="return enterKeyNav('rowDeliveryTimeInHH${loop.count}',event.keyCode);">
												<html:option value="">
										...
										<td><html:text styleId="rowDeliveryTimeInHH${loop.count}"
												...
												value='${drsDtls.deliveryTimeInHHStr}' maxlength="2" onchange="clearDeliveryTimeMinutes('${loop.count}')" onkeydown="return enterKeyNav('rowDeliveryTimeInMM${loop.count}',event.keyCode);" /> <bean:message key="label.common.colon" /><html:text styleId="rowDeliveryTimeInMM${loop.count}"
												property="to.rowDeliveryTimeInMM" styleClass="txtbox width30"
												value='${drsDtls.deliveryTimeInMMStr}' maxlength="2" onchange="validateDeliveryTime('${loop.count}')" onkeydown="return enterKeyNav('rowReceiverName${loop.count}',event.keyCode);" />
												</td>
										...
										<td><html:text styleId="rowContactNumber${loop.count}"
												...
												value='${drsDtls.contactNumber}' maxlength="10" onchange="validateContactNumber(this)" onkeypress="return onlyNumeric(event)" onkeydown="return enterKeynavForConName('${loop.count}',event.keyCode);"  /></td>
												
										<td><html:select property="to.rowCompanySealSign"
												styleId="rowCompanySealSign${loop.count}"
												styleClass="selectBox width140"
												value='${drsDtls.companySealSign}' disabled="true" onkeydown="return enterKeyNav('rowRelationId${loop.count}',event.keyCode);">
												<html:option value="">
													<bean:message key="label.common.select" />
												</html:option>
											...
											<td><html:select property="to.rowRelationId"
												...
												styleClass="selectBox width140"
												value='${drsDtls.relationId}' onkeydown="return enterKeyNav('rowIdentityProofId${loop.count}',event.keyCode);" >
												<html:option value="">
													<bean:message key="label.common.select" />
												</html:option>
											...
											<td><html:select property="to.rowIdentityProofId"
												...
												styleClass="selectBox width140"
												value='${drsDtls.identityProofTypeId}' onkeydown="return enterKeyNav('rowIdNumber${loop.count}',event.keyCode);" >
												<html:option value="">
													<bean:message key="label.common.select" />
												</html:option>
											...
											<td><html:text styleId="rowIdNumber${loop.count}"
												...
												tabindex="-1" maxlength="25" onkeydown="return enterKeyNavforDrsUpdateContactNum(event.keyCode,'${loop.count}','rowIdNumber')"/></td>
