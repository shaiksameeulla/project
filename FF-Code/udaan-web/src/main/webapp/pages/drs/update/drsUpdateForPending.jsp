...
<script type="text/javascript" src="js/drs/update/drsUpdateForPending.js"></script>
	...
	<div id="wraper">
		...
		<div id="maincontent">
			<div class="mainbody">
				<div class="formbox">
					<h1>
						<bean:message key="label.drs.pending" />
					</h1>
				...
				<div id="demo">
					...
					<div class="button_containerform">
						<br />
						<a href="#" title="Update Delivered Consignments" onclick="navigateToDrsPage('${pendingDrsForm.to.updateDeliveredUrl}')" tabindex="-1"><u><strong>
						<bean:message key="label.drs.pending.link" />
						</strong></u></a><br />
					</div>
					<!-- Button ends -->
					<table cellpadding="0" cellspacing="0" border="0" class="display"
						...
						<tbody>
                           ...
                           <tr class="${loop.index % 2 == 0 ? 'even' : 'odd'}">
                               <td><input type="checkbox" name="chkbx" value='${loop.count+1}' id="checkbox${loop.count}"  tabindex="-1" disabled="disabled"/></td>
                               <td><label><c:out value="${drsDtls.rowNumber}"/> </label></td>
                              <td><html:text styleId="rowConsignmentNumber${loop.count}" property="to.rowConsignmentNumber" styleClass="txtbox width140" value='${drsDtls.consignmentNumber}' readonly="true" tabindex="-1" maxlength="12"/></td>
                               <td align="center" >
