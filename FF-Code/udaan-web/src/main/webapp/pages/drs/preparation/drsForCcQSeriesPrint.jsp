...
<script type="text/javascript" charset="utf-8"
	src="js/drs/preparation/drsForCcQSeriesPrint.js"></script>
</head>
<body>
	...
	<table cellpadding="2" cellspacing="0" width="100%" border="0">
		<c:forEach var="dtlsTOs" items="${page}" varStatus="vstatus">
			<jsp:include page="/pages/drs/preparation/drsCreditHeader.jsp" />
			<tr>
								...
								<table cellpadding="7" cellspacing="0" width="100%" border="0"
									...
									<thead>
										<tr class="showTopBtmLine">
											...
											<td width="13%" align="left" valign="top"><bean:message
													key="label.drs.update.relationship" /></td>
											<td width="10%" align="left" valign="top"><bean:message
													key="label.print.drs.idProof" /></td>
											<td width="10%" align="left" valign="top"><bean:message
													key="label.drs.update.idNo" /></td>
										</tr>
									</thead>
										...
										<c:forEach var="dtlsTO" items="${dtlsTOs.firstCol}"
											...
											<tbody>
												<tr class="showBtmLine" style="height: 8.1em">
													...
													<td align="left" valign="top"><c:out
															value="${dtlsTO.relationship}" /></td>
													<td align="left" valign="top"><c:out
															value="${dtlsTO.idProof}" /></td>
													<td align="left" valign="top"><c:out
															value="${dtlsTO.idNumber}" /></td>
												</tr>
											</tbody>
									...
									<td width="18" align="left" valign="top"><table
											...
											<tr class="showBtmLine">
												<td colspan="2" align="left">All the deliveries checked
													&amp; tallied with address &amp; stamp on Pod by:</td>
											</tr>
											<!-- <tr>
