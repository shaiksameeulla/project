	...
	<tr>
	   <!-- <th><br></br></th> -->
    	<td align="left" valign="top">
    		...
    		<center><bean:message key="label.print.drs.prepnormdoxHeader" /></center>
       	</td>
    </tr>
	    ...
	    <td align="left" valign="top">
			<table cellpadding="2" cellspacing="5" width="100%" border="0">
        		<tr class="showTopLine">
                	...
                	<td width="45%" align="left"  >${drsTo.createdOfficeTO.officeName}-${drsTo.createdOfficeTO.officeCode}</td> 
              	...
              	<td width="10%" align="left" ><bean:message key="label.print.drs.type" /></td>
                    ...
                    <td width="30%" align="left" valign="top">  <c:out value="${drsTo.fieldStaffTO.firstName}"/>   <c:out value="${drsTo.fieldStaffTO.lastName}"/></td>
                    </c:if>
              	    <%-- <th width="5%" align="left" ><bean:message key="label.print.dateTime" /></th>
               	...
               	<tr >
                    ...
                    <td width="30%" align="left" valign="top">  <c:out value="${drsTo.franchiseTO.businessName}"/>  </td>
                   </c:if>
                    <c:if test="${not empty drsTo.coCourierTO}"> 
                    <td width="30%" align="left" valign="top">  <c:out value="${drsTo.coCourierTO.firstname}"/>   <c:out value="${drsTo.coCourierTO.lastName}"/></td>
                   </c:if>
                   
                   <c:if test="${not empty drsTo.baTO}"> 
                    <td width="30%" align="left" valign="top">  <c:out value="${drsTo.baTO.businessName}"/> </td>
                   </c:if>
                   <td width="15%" align="left" ><bean:message key="label.print.drs.timeOut" /></td>
                	<td width="15%" align="left">${drsTo.fsOutAlias}</td>
                   <td width="18%" align="left" ><bean:message key="label.print.loadNo" /></td>
                	<td width="10%" align="left" >${drsTo.loadNumber}</td>
                   <%-- <th width="5%" align="left" ><bean:message key="label.print.drs.timeIn" /></th>
                	<td width="35%" align="left">${drsTo.fsInAlias}</td> --%>
           		</tr>
              	<tr >
                	...
                	<%-- <th width="5%" align="left" ><bean:message key="label.print.drs.timeIn" /></th>
                	<td width="10%" align="left">${drsTo.fsInTime}</td> --%>
                </tr>
           </table>
       	</td>
	</tr>
