...
<script type="text/javascript" charset="utf-8"
	src="pages/rate/js/rateconfiguration/rateConfigurationCommon.js"></script>
<script type="text/javascript" charset="utf-8"
	src="pages/rate/js/rateconfiguration/baRateConfigurationForCourier.js"></script>
	<script type="text/javascript" charset="utf-8"
	src="pages/rate/js/rateconfiguration/baRateConfigurationForPriority.js"></script>
	<script type="text/javascript" charset="utf-8"
	src="pages/rate/js/rateconfiguration/baRateConfigurationForAirCargo.js"></script>
	<script type="text/javascript" charset="utf-8"
	src="pages/rate/js/rateconfiguration/baRateConfigurationForTrain.js"></script>
	...
	<html:form action="/baRateConfiguration.do" method="post" styleId="baRateConfigurationForm">
		<div id="maincontent">
			<div class="mainbody">
					...
					<table border="0" cellpadding="0" cellspacing="2" width="100%">
						<tr>
							<%-- <td width="13%" class="lable"><sup class="star">*</sup>&nbsp;<bean:message key="label.rate.configuration.frmDate" />:</td> --%>
								<html:hidden property="to.frmDate" styleId="frmDate" styleClass="txtbox width90" />
							<%-- <td width="20%" class="lable"><sup class="star">*</sup>&nbsp;<bean:message key="label.rate.configuration.toDate" />:</td> --%>
								<html:hidden  property="to.toDate" styleId="toDate" styleClass="txtbox width90" />
							<td width="20%" class="lable"><sup class="star">*</sup>&nbsp;<bean:message key="label.rate.configuration.region" />:</td>
							<td width="17%">
								<html:select property="to.regionId" styleId="regionId" styleClass="selectBox width140" onchange="getAllCities();">
							...
							<td class="lable" width="15%"><sup class="star">*</sup>&nbsp;<bean:message key="label.rate.configuration.city" />:</td>
							<td width="15%">
						...
						<tr>
							...
							<td width="15%">
								<html:select property="to.baType" styleId="baType" styleClass="selectBox width140" onchange="searchBARatesDtls('CO');">
									<html:option value=""><bean:message key="label.common.select" locale="display" /></html:option>
					...
					<div id="tabs-2">
						...
						<div id="tabs-4">
							...
							<div id="courierSpecial">
								...
								<div class="button_containerform">
									<%-- <html:button property="Save" styleClass="btnintform" disabled="false" styleId="btnCOSlabsSave" onclick="saveOrUpdateBARatesDtls('CO');" title="Save">
						...
						<div id="tabs-5" style="width: 99%">
							...
							<div>
								...
								<!-- Button -->
								<div class="button_containerform">
									<%-- <html:button property="Save" styleClass="btnintform" disabled="false" styleId="btnARSlabsSave" onclick="saveOrUpdateBARatesDtls('AR');" title="Save">
										<bean:message key="button.label.save" /></html:button>
									<html:button property="Cancel" styleClass="btnintformbigdis" disabled="false" styleId="btnARSlabsCancel" onclick="searchBARatesDtls('AR');" title="Cancel">
										<bean:message key="button.label.clear" /></html:button> --%>
								</div>
								<!-- Button ends -->
							</div>
						...
						<div id="tabs-6" style="width: 99%">
							...
							<div>
								...
								<!-- Button -->
								<div class="button_containerform">
									<%-- <html:button property="Save" styleClass="btnintform" disabled="false" styleId="btnTRSlabsSave" onclick="saveOrUpdateBARatesDtls('TR');" title="Save">
										<bean:message key="button.label.save" /></html:button><!-- btnintformbigdis -->
									<html:button property="Cancel" styleClass="btnintform" disabled="false" styleId="btnTRSlabsCancel" onclick="searchBARatesDtls('TR');" title="Cancel">
						...
						<div id="tabs-13">
									...
									<tr>
										...
										<td width="23%" class="lable1">
											<html:select property="to.baPrioritySlabRateTO.servicedOn" styleId="servicedOn" styleClass="selectBox width155" onchange="searchBARatesDtls('PR');">
		          								<%-- <html:option value=""><bean:message key="label.common.select" locale="display"/></html:option> --%>
		          								<html:option value="B">Before 14.00</html:option>
		          								<html:option value="A">After 14.00</html:option>
		          								<html:option value="S">Sunday</html:option>
		          							</html:select>
										</td>
							...
							<div>
								...
								<br></br>
								<div class="button_containerform">
									<%-- <html:button property="Save" styleClass="btnintform" styleId="btnPriorityFixedChargeSave" onclick="saveOrUpdateBARatesDtls('PR');" title="Save">
	   				 					<bean:message key="button.label.save" /></html:button>
				...
				<%-- <html:button property="Submit" styleClass="btnintformbigdis" disabled="true" styleId="btnSubmit"
					onclick="submitBaRateConfiguration();" title="Submit"> <bean:message key="button.submit" />
				</html:button>
				<html:button property="Cancel" styleClass="btnintformbigdis" disabled="true"	
