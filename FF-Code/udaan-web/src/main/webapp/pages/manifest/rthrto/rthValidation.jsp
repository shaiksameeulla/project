...
<script type="text/javascript" language="JavaScript" src="js/manifest/rthrto/rthValidation.js"></script>
</head>

<body>
<html:form action="/rthRtoValidation.do?submitName=viewRthValidation" styleId="rthRtoValidationForm">  
 <div id="wraper">  
 <div id="maincontent">
    <div class="mainbody">
      <div class="formbox">
        <h1><bean:message key="label.rth.rthValidationScreen"/></h1>
        ...
        <table border="0" cellpadding="0" cellspacing="7" width="100%">
          <tr>
            ...
            <td width="25%">            	
			    ...
			    </html:button>  <!-- onfocus="setFocusIfNullById('consignmentNumber');" -->
            	...
            	<html:hidden property="to.actualWeight" styleId="actualWeight" value="1"/>
   ...
   <div class="button_containerform">
	<html:button property="Save" styleClass="btnintform" styleId="btnSave" onclick="saveOrUpdateRthValidation();" title="Submit">
	...
	<html:button property="Cancel" styleClass="btnintform" styleId="btnCancel" onclick="cancelRth();" title="Cancel">
