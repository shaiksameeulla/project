...
<div id="wraper"> 
   <html:form action="/rthRtoManifestParcel.do" method="post" styleId="rthRtoManifestForm" >
    ...
    <div class="mainbody">
              <div class="formbox">
        <h1><bean:message key="label.rtoManifestingScreenPpx"/></h1>
     ...
     <div class="formTable">
        <table border="0" cellpadding="0" cellspacing="3" width="100%">
           ...
           <td width="15%" class="lable"><sup class="mandatoryf">*</sup><bean:message key="label.common.date"/><strong>/</strong><bean:message key="label.common.time"/>:</td>
            ...
            <td width="21%"><html:text property="to.manifestNumber" styleId="manifestNo" styleClass="txtbox width130" maxlength="10" value=""
            onkeypress = "return callEnterKey(event, document.getElementById('destRegion'));" onblur="validateManifestNo(this);"/>&nbsp;
            ...
            <html:text property="to.originOfficeTO.officeCode" styleClass="txtbox width130" styleId="originOfficeCode" readonly="true" tabindex="-1"/></td>
           ...
           <tr>
            ...
            <td width="11%" class="lable" colspan="3">
            	<table cellpadding="0" cellspacing="0" border="0" width="85%">
            		<tr>
            			<td align="left" class="lable1" width="13%"> <bean:message key="label.rto.rth.region"/><br />
            				<html:select property="to.destRegionTO.regionId" styleId="destRegion" onchange="getCitiesByRegion();" styleClass="selectBox width130"
            onkeypress = "return callEnterKey(event, document.getElementById('destCity'));">
                 ...
                 <c:forEach var="regionTO" items="${regionList}" varStatus="loop">
            		<option value="${regionTO.regionId}" ><c:out value="${regionTO.regionName}"/></option>
            			...
            			<td align="left" class="lable1" width="13%"> <bean:message key="label.rto.rth.station"/><br />
                      		<html:select property="to.destCityTO.cityId" styleId="destCity" onchange="getOfficesByCity();" styleClass="selectBox width130"
	            ...
	            <td width="14%" class="lable"><sup class="mandatoryf">*</sup><bean:message key="label.manifest.bagLockNo"/></td>
	            <td width="13%">
	            	<html:text property="to.bagLockNo" styleId="bagLockNo" styleClass="txtbox width130" value=""
					maxlength="8" onkeypress = "return callEnterKey(event, document.getElementById('consgNumber1'));" onblur="validateBagLockNo(this,'H');" />
				</td>
          </tr>
          <tr>
			<td width="14%" class="lable"><bean:message key="label.manifest.ConsignmentType"/></td>
			<td width="13%" colspan="5"><html:hidden property="to.consignmentTypeTO.consignmentId" styleId="consignmentTypeId"/>
