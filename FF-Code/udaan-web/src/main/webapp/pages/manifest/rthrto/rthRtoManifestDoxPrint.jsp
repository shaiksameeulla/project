				...
				<td align="left" valign="top">
					...
					<c:choose>
						<c:when test="${rthRtoManifestTO.manifestType== 'R'}">
							<center>
								<bean:message key="label.print.rtoManifestDox" />
							</center>
						</c:when>
						<c:otherwise>
							<center>
								<bean:message key="label.print.rthManifestDox" />
							</center>
						</c:otherwise>
					</c:choose> <!-- -------------------------------------------------------------------------------- -->
				</td>
					...
					<td align="left" valign="top">
						<table cellpadding="2" cellspacing="2" width="100%" border="0">
							<tr class="showTopLine">
								...
								<td width="50%" align="left">${rthRtoManifestTO.destCityTO.cityName}-${rthRtoManifestTO.destOfficeTO.officeName}</td>
							...
							<thead>
								...
								<tr class="showTopBtmLine">
									...
									<td width="5%" align="center" valign="top"><bean:message
											key="label.print.rtoRthOrigin" /></td>
									<td width="3%" align="center" valign="top"><bean:message
									...
									<td width="15%" align="center" valign="top"><bean:message
											key="label.print.rtoRthPendingReason" /></td>
									<td width="3%" align="center" valign="top"><bean:message
											key="label.print.rtoRthCode" /></td>
								...
								<c:forEach var="dtlsTOs"
									...
									<tr>
										...
										<td align="center"><c:out
												value="${dtlsTOs.originOfficeName}" /></td>
										...
										<td align="center"><c:out value="${dtlsTOs.reasonName}" /></td>
										<td align="center"><c:out value="${dtlsTOs.reasonCode}" /></td>
									</tr>
								</c:forEach>
							</tbody>
							...
							<tr>
								<td width="18" align="left" valign="top">
									<table cellpadding="2" cellspacing="2" width="100%" border="0">
										...
										<tr>
											<td width="28%" colspan="2"><bean:message
