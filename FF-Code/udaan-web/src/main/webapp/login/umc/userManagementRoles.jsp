			...
			<div id="maincontent">
    		 ...
    		 <input type="hidden" name="to.roleType" id="roleType" value=""></input>
              ...
              <tr>
                ...
                <html:select styleId="roleId" property="to.roleId" value="" onchange="getUserRights(this.value);">
                ...
                <td width="17%" class="center">
                 <html:text styleId="roleName" property="to.roleName" size="15"  value="" maxlength="15"  onkeypress="return isUserRoleExists(this.value,event);"/></td>
