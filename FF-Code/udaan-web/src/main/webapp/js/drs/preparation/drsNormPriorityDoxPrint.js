 ...
 */
function back(){
	var url = "/udaan-web/prepNormDoxDrs.do?submitName=viewPrepareDrsPage";
...
function setData4Print(){
	...
	function hideUrl(){
		var url = "./deliveryPrintDrs.do?submitName=printNormalDoxDrs";
		 window.open(url, "myPopup", 'toolbar=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=0,width=900,height=700');
	}
