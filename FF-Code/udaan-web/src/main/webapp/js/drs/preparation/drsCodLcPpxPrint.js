 ...
 */
function back(){
	var url = "/udaan-web/prepCodLcPpxDrs.do?submitName=viewPrepareDrsPage";
...
function hideUrl(){
		var url = "./deliveryPrintDrs.do?submitName=printCodLcPpxDrs";
		 window.open(url, "myPopup", 'toolbar=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=0,width=1100,height=900');
}
