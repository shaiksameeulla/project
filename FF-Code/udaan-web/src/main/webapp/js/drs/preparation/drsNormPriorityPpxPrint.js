 ...
 */
function back(){
	var url = "/udaan-web/prepNormPpxDrs.do?submitName=viewPrepareDrsPage";
...
function setData4Print(){
	...
	function hideUrl(){
		var url = "./deliveryPrintDrs.do?submitName=printNormalParcelDrs";
		 window.open(url, "myPopup", 'toolbar=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=0,width=800,height=1100');
	}
