 ...
 */
function back(){
	var url = "/udaan-web/inMasterBagManifest.do?submitName=viewInMBPL";
	document.inMasterBagManifestForm.action=url;
...
function hideurl(){
	var url = "./inMasterBagManifest.do?submitName=printMBPLManifest";
