 ...
 */
function back(){
	var url = "/udaan-web/inBagManifest.do?submitName=viewInBagManifestDox";
	document.inBagManifestForm.action=url;
	document.inBagManifestForm.submit();
...
function hideurl(){
	var url = "./inBagManifest.do?submitName=printBplNumberDox";
