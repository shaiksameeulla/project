 ...
 *
 */
public class UpdateNormDoxDrsAction extends AbstractDeliveryAction {
	/** The Constant LOGGER. */
	private final static Logger LOGGER = LoggerFactory
			.getLogger(UpdateNormDoxDrsAction.class);
	...
	public ActionForward viewUpdateDrsPage(final ActionMapping mapping, final ActionForm form,
		...
		LOGGER.debug("UpdateNormDoxDrsAction::viewUpdateDrsPage ..START");
		...
		LOGGER.debug("UpdateNormDoxDrsAction::viewUpdateDrsPage ..END");
	...
	public ActionForward findDrsNumberForUpdate(final ActionMapping mapping, final ActionForm form,
			final HttpServletRequest request, final HttpServletResponse response) {
		LOGGER.debug("UpdateNormDoxDrsAction::findDrsNumberForUpdate ..START");
		...
		try {
			...
			LOGGER.error("UpdateNormDoxDrsAction::findDrsNumberForUpdate ..CGBusinessException :",e);
			getBusinessError(request, e);
			drsTo= new NormalPriorityDrsTO();
		}catch (CGSystemException e) {
			LOGGER.error("UpdateNormDoxDrsAction::findDrsNumberForUpdate ..CGSystemException :",e);
			drsTo = new NormalPriorityDrsTO();
			actionMessage =  new ActionMessage(UdaanWebErrorConstants.DRS_NOT_FOUND);
		}catch (Exception e) {
			drsTo = new NormalPriorityDrsTO();
			LOGGER.error("UpdateNormDoxDrsAction::findDrsNumberForUpdate ..Exception :",e);
		...
		((NormalPriorityDrsForm) form).setTo(drsTo);
		LOGGER.debug("UpdateNormDoxDrsAction::findDrsNumberForUpdate ..END");
		return mapping.findForward(DrsConstants.SUCCESS_FORWARD);
	}
