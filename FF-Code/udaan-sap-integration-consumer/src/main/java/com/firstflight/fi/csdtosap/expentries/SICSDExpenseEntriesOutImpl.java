...
public class SICSDExpenseEntriesOutImpl implements SICSDExpenseEntriesOut {
    ...
    public void siCSDExpenseEntriesOut(DTCSDExpenseEntries mtCSDExpenseEntries) { 
        LOG.info("Executing operation siCSDExpenseEntriesOut");
        LOG.debug("mtCSDExpenseEntries::"+mtCSDExpenseEntries);
        try {
        } catch (java.lang.Exception ex) {
        	LOG.error("SICSDExpenseEntriesOutImpl::siCSDExpenseEntriesOut::error::",ex);
