 ...
 * @ author soagarwa
 * */
package src.com.capgemini.lbs.errorQueueProducer;
...
import src.com.dtdc.constants.MDBConstants;
...
public class ErrorQueueProducer {
	...
	private static void createConnection() {
		try {
			...
			logger.error("ErrorQueueProducer::createConnection::Exception occured:"
					+e.getMessage());
		}
	}
	...
	public static void sendMessage(CGBaseTO baseTO) throws CGSystemException {
		...
		try {
			...
			// Lookup Into the Q
			queue = (Queue) ctx.lookup(MDBConstants.ERROR_Q);
			...
			logger.error("ErrorQueueProducer::sendMessage::Exception occured:"
					+e.getMessage());
			/*
