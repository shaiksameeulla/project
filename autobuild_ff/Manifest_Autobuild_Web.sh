...
cd /Source/Udaan_Manifest_Trunk/
echo "Let me take some rest before taking update..."
sleep 10
svn --username=sraghave --password=August2013 update https://coconet-svn-in-01.capgemini.com/svn/repos/first_flight_udaan_project/Udaan_Manifest_Trunk/ *
...
cp /Source/Build_Config/web/jdbc.properties /Source/Udaan_Manifest_Trunk/udaan-web/src/main/webapp/WEB-INF/
cp /Source/Build_Config/web/log4j.xml /Source/Udaan_Manifest_Trunk/udaan-web/src/main/resources/
cp /Source/Udaan_Manifest_Trunk/bcun-data-sync/src/main/resources/Bcun.properties /Source/Udaan_Manifest_Trunk/udaan-web/src/main/resources/
cp /Source/Udaan_Manifest_Trunk/bcun-data-sync/src/main/resources/ftp.properties /Source/Udaan_Manifest_Trunk/udaan-web/src/main/resources/
...
mytimestamp=UdaanWebMF-$(date +%Y%m%d-%H%M)

# echo   Folders are created with this Time Stamp is $mytimestamp

mkdir  /Source/Build_Backup/$mytimestamp
cp /Source/Udaan_Manifest_Trunk/udaan-web/target/udaan-web.war  /Source/Build_Backup/$mytimestamp/udaan-web.war
...
# cp /Source/Udaan_Manifest_Trunk/udaan-web/target/udaan-web.war /opt/apache-tomcat-7.0.30_8088/webapps/
