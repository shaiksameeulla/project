...
cp /Source/Udaan_Main_Trunk/udaan-web/src/main/webapp/login/*.* /Source/Udaan_Main_Trunk/udaan-config-admin/src/main/webapp/login/
...
cp /Source/Udaan_Main_Trunk/udaan-config-admin/target/udaan-config-admin.war  /opt/apache-tomcat-7.0.30_8089/webapps
