 ...
 * 
 */
package com.capgemini.lbs.centralserver.messageproducer;
...
public class QueueProducer {
	...
	private static void createConnection() {
		try {
			...
			LOGGER.error("QueueProducer::createConnection::Exception occured:"
					+e.getMessage());
		}
	}
	...
	public static void sendMessage(CGBaseTO baseTO) throws CGSystemException {
		...
		try {
			...
			LOGGER.error("QueueProducer::sendMessage::Exception occured:"
					+e.getMessage());
