...
(function(app) {
    ...
    app.directive("swaTypeAheadDropDown", swaTypeAheadDropDown);

    swaTypeAheadDropDown.$inject = ["$compile"];

    function swaTypeAheadDropDown($compile) {

        return {
            restrict: 'E',
            template: '<ui-select ng-model="datamodel" theme="selectize" style="width: 300px; padding-left: 40px" append-to-body="true">' +
            ...
            link: {
                post: function(scope, element, attrs, ngModelCtrl) {
                    ...
                    console.log("scope.defaultindex && scope.blankoption", scope.defaultindex, scope.blankoption, scope.model, scope.optionsdata);
                    ...
                    if (scope.defaultindex && scope.blankoption) {
                        ...
                        scope.datamodel = scope.optionsdata[scope.defaultindex];
